...
@Controller
@RequestMapping("/pm/wuliuexcc")
public class PmExportShippingExCommissionController extends SupBaseController   {
    
    @Autowired
    private PmExportShippingExCommissionBusin shippingExCommissionBusin;
    ...
    public String listImportContract(SearchBean searchBean,@PathVariable String orderid){
        ...
        return "/order/wlexcc/listCustomsDeAgreement";
    }
    ...
    public AjaxDomain saveShippingExCommission(ExportShippingExCommission shippingExCommission,String taskTypeId){
        ...
        try {
            shippingExCommissionBusin.saveShippingExCommission(shippingExCommission,taskTypeId, getCurrSup().getCompanyInfo().getCombaoguan());
    ...
    public String viewShippingExCommission(@PathVariable String id) {
        ExportShippingExCommission shippingExCommission =shippingExCommissionBusin.getShippingExCommission(id);
