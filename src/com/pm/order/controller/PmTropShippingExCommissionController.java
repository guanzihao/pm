...
@Controller
@RequestMapping("/pm/wuliutrop")
public class PmTropShippingExCommissionController extends SupBaseController   {
    
    @Autowired
    private PmTropShippingExCommissionBusin shippingExCommissionBusin;
    ...
    public String listImportContract(SearchBean searchBean,@PathVariable String orderid){
        ...
        return "/order/wltrop/listCustomsDeAgreement";
    }
