...
@Controller
@RequestMapping("/Wlexcc")
public class WlExccController  extends OrganizeBaseController{
    ...
    public String listCcexcc(@PathVariable String id,SearchBean searchBean){
        ...
        String sql="select c.order_num,t.task_name,ty.flow_name,c.node_state,c.node_date,n.node_name,no.mblNo,no.hblNo"
        ...
        return "/order/orderfrom/listWlexcc";
    }
    ...
    public String listWlExccNode(@PathVariable String id,SearchBean searchBean){
        ...
        return "/order/orderfrom/listWlExccNode";
    }
