...
@Controller
@RequestMapping("/Wltransport")
public class WlTransportController  extends OrganizeBaseController{
    ...
    public String listCcexcc(@PathVariable String id,SearchBean searchBean){
        ...
        return "/order/orderfrom/listWltransport";
    }
    ...
    public String listWltransportNode(@PathVariable String id,SearchBean searchBean){
        ...
        return "/order/orderfrom/listWltransportNode";
    }
