...
@Controller
@RequestMapping("/Wmimcc")
public class WmImccController  extends OrganizeBaseController{
    ...
    public String listCcexcc(@PathVariable String id,SearchBean searchBean){
        ...
        return "/order/orderfrom/listWmimcc";
    }
    ...
    public String listWmImccNode(@PathVariable String id,SearchBean searchBean){
        ...
        return "/order/orderfrom/listWmImccNode";
    }
