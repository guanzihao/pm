...
@Controller
@RequestMapping("/Ccimcc")
public class CcImccController  extends OrganizeBaseController{
    ...
    public String listCcexcc(@PathVariable String id,SearchBean searchBean){
        ...
        return "/order/orderfrom/listCcimcc";
    }
    ...
    public String listBgExccNode(@PathVariable String id,SearchBean searchBean){
        ...
        return "/order/orderfrom/listCcImccNode";
    }
