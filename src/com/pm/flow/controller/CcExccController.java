...
@Controller
@RequestMapping("/Ccexcc")
public class CcExccController  extends OrganizeBaseController{
    ...
    public String listCcexcc(@PathVariable String id,SearchBean searchBean){
        ...
        return "/order/orderfrom/listCcexcc";
    }
    ...
    public String listCcExccNode(@PathVariable String id,SearchBean searchBean){
        ...
        return "/order/orderfrom/listCcExccNode";
    }
