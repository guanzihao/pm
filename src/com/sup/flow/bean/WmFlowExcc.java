...
/**
 * @Description: 外贸出口流程单据
 * @author Chu Zhaocheng
 * @date 2017年6月21日 下午4:10:44
 */
@SuppressWarnings("serial")
@Entity
@Table(name = "WM_Flow_EXCC")
public class WmFlowExcc extends MetaObject {
    ...
    public Date getNodeNate() {
        return nodeNate;
    }

    public void setNodeNate(Date nodeNate) {
        this.nodeNate = nodeNate;
    }
