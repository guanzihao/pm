...
@Controller
@RequestMapping("/sup/Wmexcc")
public class SupWmExccController extends OrganizeBaseController {
    ...
    public String listCcexcc(@PathVariable String id,SearchBean searchBean){
        ...
        return "/sup/order/orderfrom/listWmexcc";
    }
    ...
    public String listWmExccNode(@PathVariable String id,SearchBean searchBean){
        ...
        return "/sup/order/orderfrom/listWmExccNode";
    }
}
