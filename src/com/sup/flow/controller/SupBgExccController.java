 ...
 */
@Controller
@RequestMapping("/sup/Bgexcc")
public class SupBgExccController extends OrganizeBaseController {
    /**
     * 查询报关出口订单的单据
     * @param id 订单ID
     * @param searchBean
    ...
    public String listBgExcc(@PathVariable String id,SearchBean searchBean){
        PageBean pageBean = new PageBean(searchBean, businApi);
        System.out.println(id+"id");
        String sql="select c.bill_name,t.task_name,ty.flow_name "
                + " ,c.bussiness_no,c.custom_no,c.node_state,c.node_date,n.node_name,c.obj_id as ob,ty.obj_id as tyid"
        ...
        return "/sup/order/orderfrom/listBgexcc";
    }
    /**
     * 查看出口报关单据流程节点
     * @param id
    ...
    public String listBgExccNode(@PathVariable String id,SearchBean searchBean){
        ...
        return "/sup/order/orderfrom/listBgExccNode";
    }
}
