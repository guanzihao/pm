...
@Controller
@RequestMapping("/sup/Wlimcc")
public class SupWlImccController extends OrganizeBaseController{
    /**
     * 查询物流进口订单的单据
     * @param id 订单ID
     * @param searchBean
    ...
    public String listCcexcc(@PathVariable String id,SearchBean searchBean){
        ...
        return "/sup/order/orderfrom/listWlimcc";
    }
    ...
    public String listWlImccNode(@PathVariable String id,SearchBean searchBean){
        ...
        return "/sup/order/orderfrom/listWlImccNode";
    }
}
