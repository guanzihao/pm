...
@Controller
@RequestMapping("/sup/Bgimcc")
public class SupBgImccController extends OrganizeBaseController {
    ...
    public String listBgFlowImccNode(@PathVariable String id,SearchBean searchBean){
        ...
        return "/sup/order/orderfrom/listBgImccNode";
    }
    /**
     * 查询报关进口单据信息
     * @param id
    ...
    public String list(@PathVariable String id,SearchBean searchBean){
        ...
        pageBean.sqlquery();
        model.addAttribute("pageBean", pageBean);
        return "/sup/order/orderfrom/listBgimcc";
    }
}
