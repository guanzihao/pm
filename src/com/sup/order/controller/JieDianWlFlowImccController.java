 ...
 */
@Controller
@RequestMapping("/sup/flow/wlimccs")
public class JieDianWlFlowImccController extends SupBaseController{
    @Autowired
   ...
   private WlFlowImccBusin wlFlowImccBusin;
    ...
    public String listWlFlowImcc(@PathVariable String billId){
        ...
        String str = wlFlowImccBusin.getWlFlowImcc(billId);
            switch (str) {
            case "接单":
                result="redirect:/sup/flow/wlimccs/listOrderReceiving/" + billId+"/"+0;
                break;
            case "订舱":
                result="redirect:/sup/flow/wlimccs/listBookingSpace/" + billId+"/"+0;
                break;
            case "国内换单":
                result="redirect:/sup/flow/wlimccs/listExchangeOrder/" + billId+"/"+0;
                break;
            case "报关":
                result="redirect:/sup/flow/wlimccs/listCustomsDeclaration/" + billId+"/"+0;
                break;
            case "送货":
                result="redirect:/sup/flow/wlimccs/listDeliverGoods/" + billId+"/"+0;
                break;
       }
        return result;
    }
    ...
    public String listOrderReceiving(@PathVariable String billId,SearchBean searchBean,@PathVariable String close){
        ...
        pageBean.addQuerySQL("SELECT a.id, a.endDate, a.state, a.oneAccessory, a.acceptDate FROM WlFlowImccNode a where a.flag=0 and a.billId = ? and nodeId = ?");
        pageBean.addParams(billId);
        pageBean.addParams(nodeId);
        pageBean.query();
        model.addAttribute("pageBean", pageBean);
        model.addAttribute("billId", billId);
        WlFlowImcc wlFlowExcc=(WlFlowImcc)businApi.get(WlFlowImcc.class, billId);
        model.addAttribute("orderid", wlFlowExcc);
        model.addAttribute("close", close);
        return "/sup/order/wlimcc/listOrderReceiving";
    }
    ...
    public String editOrderReceiving(@PathVariable String id, @PathVariable String billId ) {
        ...
        model.addAttribute("billId", billId);
        return "/sup/order/wlimcc/editOrderReceiving";
    }
    ...
    public String viewOrderReceiving(@PathVariable String id) {
        WlFlowImccNode wlFlowImccNode = wlFlowImccBusin.getWlFlowImccNode(id);
        model.addAttribute("wlFlowImccNode",wlFlowImccNode);
        return "/sup/order/wlimcc/viewOrderReceiving";
    }
    ...
    public String saveOrderReceiving(WlFlowImccNode wlFlowImccNode, String billId, String[] wlFlowImccNodeFiles){
      ...
      //执行报关出口节点状态存储过程
        ...
        //执行存储过程
         bgFlowExccBusin.updateorderstate("wlim", wlFlowImcc.getOrderFromId());
        return "redirect:/sup/flow/wlimccs/listOrderReceiving/" + billId+"/"+"close";
    }
    ...
    public String listBookingSpace(@PathVariable String billId, SearchBean searchBean,@PathVariable String close){
        ...
        PageBean pageBean = new PageBean(searchBean, businApi);
        pageBean.addQuerySQL("SELECT a.id, a.endDate, a.state, a.oneAccessory, a.pol, a.pod, a.shipName, a.flight, a.mblNo, a.hblNo, a.sailDate FROM WlFlowImccNode a where a.flag=0 and a.billId = ? and nodeId = ?");
        pageBean.addParams(billId);
        pageBean.addParams(nodeId);
        ...
        model.addAttribute("orderid", wlFlowExcc);
        model.addAttribute("close", close);
        return "/sup/order/wlimcc/listBookingSpace";
    }
    ...
    public String editBookingSpace(@PathVariable String id, @PathVariable String billId) {
        ...
        model.addAttribute("wlFlowImccNode", wlFlowImccNode);
        model.addAttribute("billId", billId);
        return "/sup/order/wlimcc/editBookingSpace";
    }
    ...
    public String saveBookingSpace(WlFlowImccNode wlFlowImccNode, String billId, String[] wlFlowImccNodeFiles){
      ...
      //执行报关出口节点状态存储过程
        ...
        //执行存储过程
         bgFlowExccBusin.updateorderstate("wlim", wlFlowImcc.getOrderFromId());
        return "redirect:/sup/flow/wlimccs/listBookingSpace/" +billId+"/"+"close";
    }
    ...
    public String viewBookingSpace(@PathVariable String id) {
        WlFlowImccNode wlFlowImccNode = wlFlowImccBusin.getWlFlowImccNode(id);
        model.addAttribute("wlFlowImccNode", wlFlowImccNode);
        return "/sup/order/wlimcc/viewBookingSpace";
    }
     ...
     * @return String
     */
    @RequestMapping(value="/listExchangeOrder/{billId}/{close}")
    public String listExchangeOrder(@PathVariable String billId, SearchBean searchBean,@PathVariable String close){
        EnumFlowNode enumFlowNode=new EnumFlowNode();
        String nodeId=enumFlowNode.flownode("物流进口", "国内换单");
        PageBean pageBean = new PageBean(searchBean, businApi);
        pageBean.addQuerySQL("SELECT a.id, a.endDate, a.state, a.oneAccessory, a.arrivalDate, a.switchBillDate  FROM WlFlowImccNode a where a.flag=0 and a.billId = ? and nodeId = ?");
        pageBean.addParams(billId);
        pageBean.addParams(nodeId);
        pageBean.addOrderBy("a.state", true);
        pageBean.query();
        ...
        model.addAttribute("orderid", wlFlowExcc);
        model.addAttribute("close", close);
        return "/sup/order/wlimcc/listExchangeOrder";
    }
    ...
    public String editExchangeOrder(@PathVariable String id, @PathVariable String billId) {
        ...
        model.addAttribute("wlFlowImccNode", wlFlowImccNode);
        model.addAttribute("billId", billId);
        return "/sup/order/wlimcc/editExchangeOrder";
    }
    ...
    public String saveExchangeOrder(WlFlowImccNode wlFlowImccNode, String billId, String[] wlFlowImccNodeFiles){
        ...
        //执行存储过程
         bgFlowExccBusin.updateorderstate("wlim", wlFlowImcc.getOrderFromId());
        return "redirect:/sup/flow/wlimccs/listExchangeOrder/" +billId+"/"+"close";
    }
    ...
    public String viewExchangeOrder(@PathVariable String id) {
        WlFlowImccNode wlFlowImccNode = wlFlowImccBusin.getWlFlowImccNode(id);
        model.addAttribute("wlFlowImccNode", wlFlowImccNode);
        return "/sup/order/wlimcc/viewExchangeOrder";
    }
    ...
    public String listCustomsDeclaration(@PathVariable String billId, SearchBean searchBean,@PathVariable String close){
        ...
        PageBean pageBean = new PageBean(searchBean, businApi);
        pageBean.addQuerySQL("SELECT a.id, a.endDate, a.state, a.oneAccessory, a.releaseDate FROM WlFlowImccNode a where a.flag=0 and a.billId = ? and nodeId = ?");
        pageBean.addParams(billId);
        pageBean.addParams(nodeId);
        pageBean.addOrderBy("a.state", true);
        pageBean.query();
        ...
        model.addAttribute("orderid", wlFlowExcc);
        model.addAttribute("close", close);
        return "/sup/order/wlimcc/listCustomsDeclaration";
    }
    ...
    public String editCustomsDeclaration(@PathVariable String id, @PathVariable String billId) {
        ...
        model.addAttribute("wlFlowImccNode", wlFlowImccNode);
        model.addAttribute("billId", billId);
        return "/sup/order/wlimcc/editCustomsDeclaration";
    }
    ...
    public String saveCustomsDeclaration(WlFlowImccNode wlFlowImccNode, String billId, String[] wlFlowImccNodeFiles){
      ...
      //执行报关出口节点状态存储过程
        ...
        //执行存储过程
         bgFlowExccBusin.updateorderstate("wlim", wlFlowImcc.getOrderFromId());
        return "redirect:/sup/flow/wlimccs/listCustomsDeclaration/" + billId+"/"+"close";
    }
    ...
    public String viewCustomsDeclaration(@PathVariable String id) {
        WlFlowImccNode wlFlowImccNode = wlFlowImccBusin.getWlFlowImccNode(id);
        model.addAttribute("wlFlowImccNode", wlFlowImccNode);
        return "/sup/order/wlimcc/viewCustomsDeclaration";
    }
     ...
     * @return String
     */
    @RequestMapping(value="/listDeliverGoods/{billId}/{close}")
    public String listDeliverGoods(@PathVariable String billId, SearchBean searchBean,@PathVariable String close){
        EnumFlowNode enumFlowNode=new EnumFlowNode();
        String nodeId=enumFlowNode.flownode("物流进口", "送货");
        PageBean pageBean = new PageBean(searchBean, businApi);
        pageBean.addQuerySQL("SELECT a.id, a.endDate, a.state, a.oneAccessory, a.vehicleDate, a.transDate FROM WlFlowImccNode a where a.flag=0 and  a.billId = ? and nodeId = ?");
        pageBean.addParams(billId);
        pageBean.addParams(nodeId);
        pageBean.addOrderBy("a.state", true);
        pageBean.query();
        ...
        model.addAttribute("orderid", wlFlowExcc);
        model.addAttribute("close", close);
        return "/sup/order/wlimcc/listDeliverGoods";
    }
    ...
    public String editDeliverGoods(@PathVariable String id, @PathVariable String billId) {
        ...
        model.addAttribute("wlFlowImccNode", wlFlowImccNode);
        model.addAttribute("billId", billId);
        return "/sup/order/wlimcc/editDeliverGoods";
    }
    ...
    public String saveDeliverGoods(WlFlowImccNode wlFlowImccNode, String billId, String[] wlFlowImccNodeFiles){
      ...
      //执行报关出口节点状态存储过程
        ...
        //执行存储过程
         bgFlowExccBusin.updateorderstate("wlim", wlFlowImcc.getOrderFromId());
        return "redirect:/sup/flow/wlimccs/listDeliverGoods/" + billId+"/"+"close";
    }
    ...
    public String viewDeliverGoods(@PathVariable String id) {
        WlFlowImccNode wlFlowImccNode = wlFlowImccBusin.getWlFlowImccNode(id);
        model.addAttribute("wlFlowImccNode", wlFlowImccNode);
        return "/sup/order/wlimcc/viewDeliverGoods";
    }
    /**
     * 跳转至物流进口订单页面
     * @return
     */
    @RequestMapping("/toWlFlowImccOrder")
    public String toWlFlowImccOrderPage(){
     ...
     * @return
     */
    @RequestMapping(value="/listWlFlowImccOrder/{nodeType}/{flowId}")
    public String showWlFlowImccOrderList(@PathVariable String nodeType,@PathVariable String flowId,SearchBean searchBean){
        PageBean pageBean = new PageBean(searchBean, businApi);
