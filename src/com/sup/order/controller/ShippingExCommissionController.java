...
@Controller
@RequestMapping("/sup/wuliuimcc")
public class ShippingExCommissionController extends SupBaseController   {
    
    @Autowired
    private ShippingExCommissionBusin shippingExCommissionBusin;
    ...
    public String listImportContract(SearchBean searchBean,@PathVariable String orderid,@PathVariable String nodeType,@PathVariable String flowId,@PathVariable String isCompany){
        ...
        return "/sup/order/wlimcc/listCustomsDeAgreement";
    }
    ...
    public String saveObject(ShippingExCommission shippingExCommission,String fileArray[],@PathVariable String nodeType,@PathVariable String flowId,@PathVariable String isCompany
            ){
        ...
        return "redirect:/sup/wuliuimcc/viewCustomsDeAgreement/"+shippingExCommission.getOrderFromId()+"/"+nodeType+"/"+flowId+"/"+isCompany;
    }
     ...
     * @return
     */
    @RequestMapping(value = "/editShippingExCommission/{id}/{nodeType}/{flowId}/{isCompany}")
    public String editShippingExCommission(@PathVariable String id,@PathVariable String nodeType,@PathVariable String flowId,@PathVariable String isCompany) {
        ShippingExCommission se =shippingExCommissionBusin.getObject(id);
        ...
        model.addAttribute("flowId", flowId);
        model.addAttribute("isCompany",isCompany);
       return "/sup/order/customer/editShippingExCommission";
    }
}
