...
@Controller
@RequestMapping("/sup/order/add")
public class OrderFromAddController extends SupBaseController {
    ...
    public String listorderadd(@PathVariable String orderid,SearchBean searchBean){
        ...
        model.addAttribute("ids", this.getCurrSup().getId());
        
        return "/sup/order/listorderAdd";
    }
    ...
    public String savelistorder(DingdanAddtion dingdanAddtion, String[] typeIds, String[] infoFiles){
        ...
        if(dingdanAddtions!=null){
            ...
            dingdanAddtion.setCreateuser(this.getCurrSup().getId());
            businApi.save(dingdanAddtion);
            frameworkBusin.saveUploadFileOwner(dingdanAddtion, infoFiles);
        }
        return "redirect:/sup/order/add/viewlistorderadd/"+dingdanAddtion.getId();
    }
