package com.sup.chatroom.controller;
 ...
 */
@Controller
@RequestMapping("/sup/supchatroom")
public class SupChatRoomController extends SupBaseController {
    ...
    public String showChat() {
        ...
        return "/sup/chatroom/supchatroom/showChat";
    }
        ...
        if (!StringUtil.isEmpty(userIds)) {
            ...
            for (String id : nuserIds) {
                ...
                if (userAccount != null) {
                    ...
                    chatRoom.setFromSupCompanyInfo(getCurrSup().getSupCompanyInfo());
                    chatRoom.setCompanyInfoUser(getCurrSup());
    ...
    public void listChat() {
        ...
        List<ChatRoom> chatList = chatRoomBusin.getChatRoomListBySupCompanyInfo(getCurrSup().getSupCompanyInfo());
