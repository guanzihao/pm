 ...
 */
@Controller
@RequestMapping("/sup/comchatroom")
public class ComChatRoomController extends SupBaseController {
    ...
    public String showChat() {
        ...
        return "/sup/chatroom/comchatroom/showChat";
    }
        ...
        if (!StringUtil.isEmpty(userIds)) {
            ...
            for (String id : nuserIds) {
                ...
                if (userAccount != null) {
                    ...
                    chatRoom.setFromCompanyInfo(getCurrSup().getCompanyInfo());
    ...
    public void listChat() {
        ...
        List<ChatRoom> chatList = chatRoomBusin.getChatRoomListByCompanyInfo(getCurrSup().getCompanyInfo());
