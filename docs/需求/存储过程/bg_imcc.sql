...
begin
	...
	fetch next from curCustomimport into  @id,@orderNum,@BussinessNo,@CustomNo,@customcode,@Department,@cselfNo,@items,@gross,@flight,@waybillno,@Operatingunit,@itemName,@lastupdate,@flag
