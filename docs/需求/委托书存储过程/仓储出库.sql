...
begin
		...
		declare	@pur_order_no varchar(50)
		declare	@buyer varchar(50)
		declare	@total_amount varchar(50)
		declare	@issue_date datetime
		declare	@project varchar(50)
		declare	@b_telphone varchar(50)
		declare	@b_fax varchar(50)
		declare	@supplier varchar(50)
		declare	@supplier_no varchar(50)
		declare	@contact_person varchar(50)
		declare	@cp_address varchar(50)
		declare	@cp_telephone varchar(50)
		declare	@cp_fax varchar(50)
		declare	@contract_term varchar(50)
		declare	@delivery_date varchar(50)
		declare	@instr_destination varchar(50)
		declare	@payment_term varchar(50)
		declare	@trade_condition varchar(50)
		declare	@ref_ocuments varchar(50)
		declare	@pcl varchar(50)
		declare	@currency varchar(50)
		declare	@tooling_cost  decimal(18, 4)
		declare	@pay_way varchar(50)
		declare	@tooling_life varchar(50)
		declare	@share_amount decimal(18, 4)
		declare	@share_per_price decimal(18, 4)
	...
	while (@@fetch_status=0)
				...
				set @newDate=REPLACE(CONVERT(varchar(100), GETDATE(), 23),'-',''); 
				 ...
				 IF @oldDate=@newDate
					...
					begin 	
						...
						select  @counts=count(obj_id) from PURCHASE_EXPORTRYORDER_PRODUCTION where order_from_id=@orderFromId;
						IF @counts>0
							BEGIN
								insert into PURCHASE_EXPORTRYORDER_PRODUCTION(
												obj_Id,
												obj_createDate,
												obj_updateDate,
												task_id,
		...
		ELSE
		 ...
		 Fetch Next From curCustomexport into  @id,@orderNum,@BussinessNo,@CustomNo,@customcode,@Department,@cselfNo,@items,@gross,@flight,@waybillno,@Operatingunit,@itemName,@lastupdate,@flag,@hs_code,@im_ex_date,@trade_type,@origin_place,@others,@tel,@amount
