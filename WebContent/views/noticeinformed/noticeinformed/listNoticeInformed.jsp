			                            ...
			                            <div id="tab-1" class="tab-pane active">
			                                <div class="panel-body">
			                                    <div class="dataTables_wrapper form-inline">
													<form id="pageForm" action="${basePath }/noticeinformed/noticeinformed/listNoticeInformed" class="form-horizontal formValidate" method="post">
														<div class="row">
												                ...
												                <tbody>
												                	<c:forEach items="${pageBean.pageList }" var="item" varStatus="status">
																		<tr id="toolTr_${item[0]}">
																			...
																			<td>
																				<pm:auth authCode="noticeinformed_listNoticeInformed">
																					<a class="" href="${basePath }/noticeinformed/noticeinformed/viewSNoticeInformed/${item[0] }">
																						<span>查看</span>
																					</a>
																				</pm:auth>
																			</td>
