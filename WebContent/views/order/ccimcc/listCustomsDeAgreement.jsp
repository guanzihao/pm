				...
				<div class="ui2-tab-body ui2-tab-content">
					...
					<div id="myTabContent" class="tab-content" style="border: 1px solid #dedede; border-top: 0px;padding: 5px;">
						<div id="weituohan" class="tab-pane fade"> 
								...
								<div>致云贸通企业服务有限公司：</div>
								<div>      我方了解并同意：《本服务委托函》（简称“委托函”），为我方与贵司签署的《服务协议书》（简称“服务协议”）的补充内容，委托函的内容与服务协议中约定不一致的，以委托函中内容为准；其他未尽事宜，以服务协议中内容为准。
										
										       我方了解并同意：本委托函出具后，需待贵司确认接受委托后双方的委托代理关系方成立。
										
										       我方现就服务委托贵司办理的事项及货物相关信息确认如下：</div>
										...
										<c:forEach items="${pageBean.pageList}" var="item">
														...
														<div style="width:50%;float:left;"
																...
																<div class="ui-form-control">
																	<span class="J-display">${item[34]}</span>
																</div>
															</div>
															<div style="width:50%;float:left;"
																class="ui-form-item  node-entity entity-name-expect-declaration-date entity-type-calendar ui-view-mode"
																...
																<div class="ui-form-control">
																	<span class="J-display">${item[35]}</span>
																</div>
															</div>
															<div style="width:50%;float:left;"
																class="ui-form-item  node-entity entity-name-expect-declaration-date entity-type-calendar ui-view-mode"
								...
								<div style="width:100%;margin-top:50px;float:left;">      
											我方承诺对上述委托及信息的真实性、准确性、合法性及有效性负责，如因上述信息错误导致的一切费用、损失及责任均由我方承担，包括但是不限于海关查验，无法向税务局申请出口退税等。
										      我方承诺上述货物已与海关买家签订相关的贸易合同并与海外买家约定由贵司代为出口及代收外汇。
										      我方同意，贵司有权将上述服务项目的一部分或者全部交由贵司之关联公司操作，我方承担配合贵司及、或贵司之关联公司的操作并接受其服务。
										      我方了解并同意，有关服务及财务事项（特别是收付汇款账号及发票信息），应以法律认可书面方式与贵司沟通及确认，否则由此导致的损失由我方自行承担。
										三、委托费用
										         上述委托的费用由双方另行确定，以双方确认的报价单或合作协议约定，且收费标准可能发生变动，此服务委托单之费用结算以实际发生的为准。
								</div>
								<div style="width:100%;margin-top:50px;float:left;"> 甲方：</div>
								<div style="width:100%;margin-top:50px;float:left;"> 乙方：${username.userName}     </div>
								<div style="width:100%;margin-top:50px;float:left;">
								<c:forEach items="${pageBean.pageList}" var="item">
								日期：${item[26]}
								</c:forEach></div>
		                ...
		                <div class="ibox-content" style="height: 100%;">
							<form id="pageForm1" action="${basePath }" method="post">
								<div class="col-sm-2">
									<c:import url="/views/order/ccimcc/CcFlowImccOrderTree.jsp">
	                        ...
	                        <div class="col-sm-10">
	                       		 <iframe id="deptUserList" src="${basePath }/Ccimcc/listCcimcc/${order_code.id}" frameborder="1" width="100%" ></iframe>
	                        </div>
						</div>
					</div>
						</div>
