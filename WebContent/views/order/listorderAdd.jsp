	            ...
	            <div class="ibox">
	                ...
	                <div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<form id="pageForm" class="form-horizontal formValidate" action="${basePath }/pm/order/add/listorderadd/${orderid }"  method="post">
								<%-- <div class="row">
		                            <div class="col-sm-12">
		                        ...
		                        <div class="row">
									<div class="col-sm-12 tables_search_label">
											<a class="btn btn-white btn-sm myBtn" href="javascript:;" onclick="openLayerSize('添加','${basePath }/pm/order/add/editlistorderadd/${orderid }',true,'800px','800px')">
												 添加
											</a>
									</div>
								</div>
								...
								<div>
									<c:if test="${item[3] == ids }">
										<a class="" href="javascript:;" onclick="openLayerSize('维护','${basePath }/pm/order/add/editlistorderadd/${item[0]}',true,'800px','500px')">
											<span> 维护</span>
										</a>
										<a class="" href="javascript:;" onclick="openLayerSize('维护','${basePath }/pm/order/add/removelistorderadd/${item[0]}',true,'800px','500px')">
											<span> 删除</span>
										</a>
									</c:if>
