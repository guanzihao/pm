	            ...
	            <div class="ibox">
	                ...
	                <div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<form id="pageForm" action="${basePath }/cms/content/findCMSContent" class="form-horizontal formValidate" method="post">
								<div class="row">
		                            <div class="col-sm-12">
		                        ...
		                        <div class="row">
									<div class="col-sm-12 tables_search_label">
										<pm:auth authCode="role_editOrgRole">
											<a class="btn btn-white btn-sm myBtn" href="javascript:;" onclick="openLayer('添加','${basePath }/cms/content/initCMSContent',true)">
												<span>添加</span>
											</a>
										</pm:auth>
										<pm:auth authCode="role_removeOrgRole">
											<a class="btn btn-white btn-sm myBtn" href="javascript:;" onclick="toolTable('${basePath }/cms/content/removeCMSContent', 'ids', 'removeToolTableTr', '删除')">
												<span>删除</span>
											</a>
										</pm:auth>
									</div>
									...
									<table class="table ">
										<thead>
											<tr>
												...
												<th class="sorting<c:if test="${searchBean.searchOrderName eq 'a.columnID'}">${searchBean.searchOrderType ? '_desc' : '_asc'}</c:if>" onclick="goSubmitSort('a.columnID', ${!searchBean.searchOrderType})">所属栏目</th>
										...
										<tbody>
											<c:forEach items="${pageBean.pageList }" var="item" varStatus="status">
												<tr id="toolTr_${item[0] }">
													...
													<td>
														<pm:auth authCode="role_editOrgRole">
															<a class="" href="javascript:;" onclick="openLayerSize('修改','${basePath }/cms/content/editCmsContent/${item[0] }', true,'90%','90%')">
																<span> 修改</span>
															</a>
														</pm:auth>
														<pm:auth authCode="organize_listLoginLog">
															<a class="" href="javascript:;" onclick="openLayer('查看详情','${basePath }/cms/content/detailCmsContent/${item[0]}',false)">
																<span>查看详情</span>
															</a>
														</pm:auth>
													</td>
