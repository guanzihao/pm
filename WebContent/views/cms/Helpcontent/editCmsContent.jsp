				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form id="tijiao" class="form-horizontal formValidate"
							action="${basePath }/cms/Helpcontent/updateCMSContent" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
										<input type="text" style="display:none;" id="content" name="content" value="${cmsContent.content }"/>
