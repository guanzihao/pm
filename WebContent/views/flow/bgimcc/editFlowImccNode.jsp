	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/flow/bgimcc/saveFlowImccNode" method="post">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-4"><input type="text" name="bussinessDate" class="form-control  date-picker" value="${flowImccNode.bussinessDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
							...
							<div id="outGroup">
							      <div class="form-group" >
									<div class="col-sm-10">
									<label class="control-label">操作公司<font>*</font></label>
