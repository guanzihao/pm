		...
		<div class="row">
	    	<div class="col-sm-12 tables_search_label">
				...
				<pm:authCom authCode="info_listAllComLoginLog">
		        	<a class="btn btn-success" href="${basePath }/sup/flow/bgimcc/listBgFlowImccCheck/${billId}">
						<span>查验</span>
					</a>
				</pm:authCom>
				<pm:authCom authCode="sup_listAllComLoginLog">
					<a class="btn btn-success" href="${basePath }/sup/flow/bgimcc/listBgFlowImccGreenLight/${billId}">
						<span>放行</span>
					</a>
				</pm:authCom>	
	        </div>
	            ...
	            <div class="ibox float-e-margins">
	                <div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<form id="pageForm" action="${basePath }/sup/flow/bgimcc/listBgFlowImccOrderReceiving/${billId}" class="form-horizontal formValidate" method="post">
		                        <div class="row">
									<div class="col-sm-12 tables_search_label">
										<pm:authCom authCode="organize_editInterface">
											<a class="btn btn-white btn-sm" href="javascript:;" onclick="openLayer('添加','${basePath }/sup/flow/bgimcc/editFlowImccNode/0/${billId }',true)">
												<span> 添加</span>
											</a>
										</pm:authCom>
										<pm:authCom authCode="organize_removeInterface">
											<a class="btn btn-white btn-sm" href="javascript:;" onclick="toolTable('${basePath }/sup/flow/bgimcc/removeFlowImccNode', 'ids', 'removeToolTableTr', '删除')">
												<span>删除</span>
											</a>
										</pm:authCom>
									</div>
												...
												<tr id="toolTr_${item[0] }">
													...
													<td>
														<pm:authCom authCode="role_editOrgRole">
															<a class="btn btn-white btn-xs" href="javascript:;" onclick="openLayer('修改','${basePath }/sup/flow/bgimcc/editFlowImccNode/${item[0] }/${billId }', true)">
																<span> 修改</span>
															</a>
														</pm:authCom>
														<pm:authCom authCode="organize_listLoginLog">
															<a class="btn btn-xs btn-white" href="javascript:;" onclick="openLayer('查看详情','${basePath }/sup/flow/bgimcc/viewFlowImccNode/${item[0]}/${billId }',false)">
																<span> 查看详情</span>
															</a>
														</pm:authCom>
													</td>
													...
													<td>
														<pm:execute id="bgFlowExccBusin" bean="bgFlowExccBusinImpl" method="getFlowExccNode">
