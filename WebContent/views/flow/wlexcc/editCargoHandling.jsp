	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/flow/wlexcc/saveCargoHandling" method="post">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-4"><input type="text" name="vehicleDate" class="form-control input-sm date-picker" value="${wlFlowExccNode.vehicleDate}" maxlength="200"></div>
	                            <label class="col-sm-2 control-label">运输完成时间</label>
	                            <div class="col-sm-4"><input type="text" name="transDate" class="form-control input-sm date-picker" value="${wlFlowExccNode.transDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
