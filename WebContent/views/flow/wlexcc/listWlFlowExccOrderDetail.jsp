			                            ...
			                            <div id="tab-1" class="tab-pane active">
			                                <div class="panel-body">
			                                    <div class="dataTables_wrapper form-inline">
													<form id="pageForm" action="${basePath }/flow/wlexcc/listWlFlowExccOrder/${nodeType}/${flowId}/${companyid}" class="form-horizontal formValidate" method="post">
														<div class="row">
								                            <div class="col-sm-12">
																					...
																					<c:choose>
																				          <c:when test="${item[12] eq '12'}">
																					          ...
																					          <a class="quxiao" href="javascript:;" onclick="toolTableUpdate('${basePath }/flow/bgimcc/supupdateorder','${item[0] }','拒绝订单')">
																					           ...
																					           <a class="" target="iframe_PM" href="${basePath }/pm/wuliuexcc/viewCustomsDeAgreement/${item[0] }">
																						               <span> 查看</span>
																					             </a>     
																				          </c:when>
