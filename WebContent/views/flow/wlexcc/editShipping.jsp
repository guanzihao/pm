	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/flow/wlexcc/saveShipping" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label">实际出运时间</label>
	                            <div class="col-sm-4"><input type="text" name="shippingDate" class="form-control input-sm date-picker" value="${wlFlowExccNode.shippingDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
