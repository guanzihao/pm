	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/flow/wlexcc/saveBookingSpace" method="post">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-4"><input type="text" name="sailDate" class="form-control input-sm date-picker" value="${wlFlowExccNode.sailDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
