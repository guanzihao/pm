	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/flow/ccimcc/saveCcFlowImccNodeStoredSign" method="post">
	                        ...
	                        <div class="form-group">
	                         ...
	                         <div class="form-group">
	                        	<label class="col-sm-2 control-label">入库完成时间</label>
	                            <div class="col-sm-4"><input type="text" name="storedFinishDate" class="form-control input-sm date-picker" value="${ccFlowImccNode.storedFinishDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
