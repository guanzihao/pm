	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/flow/ccimcc/saveCcFlowImccNode" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label">接单登记时间</label>
	                            <div class="col-sm-4"><input type="text" name="orderReceivingDate" class="form-control input-sm date-picker" value="${ccFlowImccNode.orderReceivingDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
