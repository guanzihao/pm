	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/flow/ccexcc/saveCcFlowExccNode" method="post">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-4"><input type="text" name="orderReceivingDate" class="form-control input-sm date-picker" value="${ccFlowExccNode.orderReceivingDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
