	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/flow/bgexcc/saveFlowExccNodeCheck" method="post">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-4"><input type="text" name="inspectionDate" class="form-control  date-picker" value="${flowExccNode.inspectionDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
