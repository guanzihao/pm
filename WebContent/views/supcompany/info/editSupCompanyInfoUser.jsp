	            ...
	            <div class="ibox float-e-margins">
	                <div class="ibox-title">
	                    ...
	                    <div class="ibox-tools">
		                     <a class="btn btn-xs btn-white" href="${basePath }/supcompany/info/viewSupCompanyInfo/${supcompanyInfo.id}">
		                         <i class="fa fa-share"></i> 返回
		                     </a>
						</div>
	                </div>
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/supcompany/info/saveSupCompanyInfoUser" method="post">
	                        <input type="hidden" name="token" value="${token}">
	                        <input type="hidden" name="id" value="${companyInfoUser.id}">
	                        <input type="hidden" name="comId" value="${supcompanyInfo.id}">
							<div class="form-group">
	                        	<label class="col-sm-2 control-label">邮箱(登录名)<font>*</font></label>
	                            <div class="col-sm-10"><input type="text" name="userMail" class="form-control" value="${companyInfoUser.userMail }" required="" email="true"  maxlength="100" remote="${basePath}/supcompany/info/ajaxCheckSupCompanyInfoUser?id=${companyInfoUser.id}"></div>
	                        </div>
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-4"><input type="text" name="userTel" class="form-control" value="${companyInfoUser.userTel }" required="" maxlength="15" remote="${basePath}/supcompany/info/ajaxCheckSupCompanyInfoUser?id=${companyInfoUser.id}"></div>
