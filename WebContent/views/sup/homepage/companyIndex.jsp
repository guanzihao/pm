...
<script src="${basePath }/resource/js/echarts.min.js"></script>
	<body class="gray-bg" style="height:900px;">	
		...
		<div style="font-size: 16px ;z-index: 1"> 您有<font ><a href="${basePath }/sup/order/OrderFrom/listStatusOrder?searchName1=88" style="color: red;">${orderNum}</a></font>个订单 </div>
			...
			<div style="text-align: center;">
			     <div id="echartsPie" style="width: 456px;height:300px;margin-left:25px;"></div>
			</div>
		</div>
		</div>
...
<script type="text/javascript">
	...
	function showMenu(){
	    window.location.href="${basePath}/sup/company/homePage/companyHome";
	}
	...
	function showProp(obj) {
		$.ajax({
			type : "post",
			url : "${basePath }/sup/company/homePage/SearchBillPropByCompany",
			dataType : "json",
			async : false,
	...
	function showBar(echarts,checkData) {
		$.ajax({
			type : "post",
			url : "${basePath }/sup/company/homePage/searchOrderByCompany",
			dataType : "json",
			async : false,
	...
	$(".submitClass").on("click",function(){
		window.location.href='${basePath }/sup/order/OrderFrom/listStatusOrder?searchName1=9';
	});
	$(".distributionClass").on("click",function(){
		window.location.href='${basePath }/sup/order/OrderFrom/listStatusOrder?searchName1=13';
	});
	$(".accomplishClass").on("click",function(){
		window.location.href='${basePath }/sup/order/OrderFrom/listStatusOrder?searchName1=7';
	});
