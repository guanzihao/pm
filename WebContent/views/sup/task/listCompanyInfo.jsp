	        ...
	        <div class="col-lg-12">
	            <div class="ibox">
	                ...
	                <div class="ibox-content">
						...
						<input type="hidden" id="editWmId" value="${editWm }">
							<form id="pageForm" class="form-horizontal formValidate" action="${basePath }/sup/task/listCompanyInfo/${taskTypeId}//${flag}"  method="post">
								<div class="row">
		                            <div class="col-sm-12">
...
<script type="text/javascript">
	function hide(ids) {
		...
		var editWm=$("#editWmId").val();
		switch (editWm) {
		case "editWmIc":
			parent.returnValueWmIc(toValue);
			break;
		case "editWmEc":
			parent.returnValueWmEc(toValue);
			break;
		default:
