			                            ...
			                            <div id="tab-1" class="tab-pane active">
			                                <div class="panel-body">
			                                    <div class="dataTables_wrapper form-inline">
													<form id="pageForm" action="${basePath }/sup/supcompany/supcompany/listSupNoticeInformed" class="form-horizontal formValidate" method="post">
														<div class="row">
								                            <div class="col-sm-12">
								                                <label class="tables_search_label">
								                                	关键字：<input style="width:200px" type="text" class="my_input" name="searchName1" value="${pageBean.searchBean.searchName1 }">
								                                </label>
								                                <label class="tables_search_label">
												                ...
												                <tbody>
												                	<c:forEach items="${pageBean.pageList }" var="item" varStatus="status">
																		<tr id="toolTr_${item[0]}">
																			...
																			<td>
																				<pm:authCom authCode="noticeinformed_editSupNoticeInformed">
																					<a class="" href="${basePath }/sup/supcompany/supcompany/viewSupNoticeInformed/${item[0] }">
																						<span>查看</span>
																					</a>
																				</pm:authCom>
																			</td>
