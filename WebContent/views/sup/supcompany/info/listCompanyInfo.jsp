	            ...
	            <div class="ibox">
	                ...
	                <div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<form id="pageForm" class="form-horizontal formValidate" action="${basePath }/supcompany/info/listCompanyInfo"  method="post">
								<div class="row">
		                            <div class="col-sm-12">
		                        ...
		                        <div class="row">
									<div class="col-sm-12 tables_search_label">
										<pm:auth authCode="info_editCompanyInfo">
											<a class="btn btn-white btn-sm myBtn" href="javascript:;" onclick="openLayer('添加','${basePath }/company/info/editCompanyInfo/0',true)">
												<span> 添加</span>
											</a>
										</pm:auth>
										...
										<tbody>
											<c:forEach items="${pageBean.pageList }" var="item" varStatus="status">
												<tr>
													...
													<td>
														<a href="javascript:;" onclick="openLayer('查看','${basePath }/supcompany/info/viewCompanyInfo/${item[0]}',false)">${item[1] }</a>
													</td>
													<td>${item[2] }</td>
													<td>
														<c:choose>
													...
													<td>
														<pm:auth authCode="info_editCompanyInfo">
															<a class="" href="javascript:;" onclick="openLayer('维护','${basePath }/company/info/editCompanyInfo/${item[0]}',true)">
																<span>维护</span>
															</a>
														</pm:auth>
													</td>
