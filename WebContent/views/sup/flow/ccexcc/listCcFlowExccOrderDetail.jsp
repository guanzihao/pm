			                            ...
			                            <div id="tab-1" class="tab-pane active">
			                                <div class="panel-body">
			                                    <div class="dataTables_wrapper form-inline">
													<form id="pageForm" action="${basePath }/sup/supcompany/order/showCcFlowExccOrderList/${nodeType}/${flowId}/${isCompany}" class="form-horizontal formValidate" method="post">
														<div class="row">
								                            <div class="col-sm-12">
																				       ...
																				       <!-- 服务商  -->
																				        <c:choose>
																				               <c:when test="${item[8] eq '9'}">
																					                  ...
																					                  <a class=""target="iframe_PM" href="${basePath }/sup/order/ExportOrderFrom/viewCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                   <span> 查看</span>
																					                  </a>
																				               </c:when>
																				              <c:when test="${item[8] eq '10'}">
																				                           <a class=""  onclick="openLayers('添加','${basePath }/sup/orderCccontroller/orderCc/${item[0]}/ccex',true)">
																							                  <span>维护进度</span>
																						                   </a> 
																						                    <a  class=""  target="iframe_PM" href="${basePath }/sup/order/ExportOrderFrom/editExportPurchaseOrderProduction/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                       <span>修改</span>
																					                        </a>
																						                    <a class=""target="iframe_PM" href="${basePath }/sup/order/ExportOrderFrom/viewCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                        <span> 查看</span>
																		                 ...
																		                 <c:when test="${item[8] eq '1'}">
																		                  ...
																		                  <c:when test="${item[8] eq '9'}">
																		                    ...
																		                    <c:when test="${item[8] eq '11'}">
																					             ...
																					             <a target="iframe_PM" class="" href="${basePath }/sup/order/ExportOrderFrom/editExportPurchaseOrderProduction/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						               <span>修改</span>
																					             </a>
																					             <a class="quxiao" href="javascript:;" onclick="toolTableUpdate('${basePath }/sup/supcompany/order/updateorder','${item[0] }','撤回订单')">
																						               <span>撤回</span>
