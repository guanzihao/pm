	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/ccexcc/saveCcFlowExccNodeExport" method="post">
	                        <input type="hidden" name="id" value="${ccFlowExccNode.id}">
	                        <input type="hidden" name="billId" value="${billId}">
	                        <div class="form-group">
	                        	<label class="col-xs-2 control-label">开始时间</label>
	                            <div class="col-xs-4"><input type="text" name="startDate" class="form-control input-sm date-picker" value="${ccFlowExccNode.startDate}" maxlength="200"></div>
	                            <!-- input-sm date-picker -->
	                            <label class="col-xs-2 control-label">结束时间</label>
	                            <div class="col-xs-4"><input type="text" name="endDate" class="form-control input-sm date-picker"  value="${ccFlowExccNode.endDate}" maxlength="50"></div>
	                        </div>
	                        
	                       <div class="form-group">
	                       		<label class="col-xs-2 control-label">送货地址</label>
	                            <div class="col-xs-4">
	                               <input type="text" name="deliveryAddr" class="form-control" value="${ccFlowExccNode.deliveryAddr}">
	                            </div>
	                       </div>
	                       <div class="form-group">
	                        	<label class="col-xs-2 control-label" style="padding-left: 0px;">司机签收时间</label>
	                            <div class="col-xs-4"><input type="text" name="driverSignDate" class="form-control input-sm date-picker" value="${ccFlowExccNode.driverSignDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
