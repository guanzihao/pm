	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/wlimcc/saveExchangeOrder" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-xs-2 control-label">实际到港时间</label>
	                            <div class="col-xs-4"><input type="text" name="arrivalDate" class="form-control input-sm date-picker" value="${wlFlowImccNode.arrivalDate}" maxlength="200"></div>
	                            <label class="col-xs-2 control-label">换单时间</label>
	                            <div class="col-xs-4"><input type="text" name="switchBillDate" class="form-control input-sm date-picker" value="${wlFlowImccNode.switchBillDate}" maxlength="200"></div>
	                        </div>
