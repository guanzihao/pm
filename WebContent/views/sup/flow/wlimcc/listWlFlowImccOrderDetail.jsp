			                            ...
			                            <div id="tab-1" class="tab-pane active">
			                                <div class="panel-body">
			                                    <div class="dataTables_wrapper form-inline">
													<form id="pageForm" action="${basePath }/sup/supcompany/order/listWlFlowImccOrder/${nodeType}/${flowId}/${isCompany}" class="form-horizontal formValidate" method="post">
														<div class="row">
								                            <div class="col-sm-12">
																				       ...
																				       <!-- 服务商  -->
																				        <c:choose>
																				               <c:when test="${item[12] eq '9'}">
																					                  ...
																					                  <a class=""target="iframe_PM" href="${basePath }/sup/wuliuimcc/viewCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                   <span> 查看</span>
																					                  </a>
																				               </c:when>
																				              <c:when test="${item[12] eq '10'}">
																				                           <a class=""  onclick="openLayers('添加','${basePath }/sup/orderCccontroller/orderCc/${item[0]}/wlim',true)">
																							                  <span>维护进度</span>
																						                   </a> 
																						                    <a class="" target="iframe_PM" href="${basePath }/sup/wuliuimcc/editShippingExCommission/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                       <span>修改</span>
																					                        </a>
																						                    <a class=""target="iframe_PM" href="${basePath }/sup/wuliuimcc/viewCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                        <span> 查看</span>
...
// 展开
       $(".spread-node").click(function(){
            ...
            if(domName=="展开"){
                 $(this).parent().parent().prevAll().find("div").css("display","block");
                 $(this).html("收起");
             }else{
                 $(this).parent().parent().prevAll().find("div").css("display","none"); 
                  $(this).html("展开");
             }
