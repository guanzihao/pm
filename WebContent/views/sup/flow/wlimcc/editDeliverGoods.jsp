	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/wlimcc/saveDeliverGoods" method="post">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-xs-4"><input type="text" name="vehicleDate" class="form-control input-sm date-picker" value="${wlFlowImccNode.vehicleDate}" maxlength="200"></div>
	                            <label class="col-xs-2 control-label" style="padding-left: 0px;">运输完成时间</label>
	                            <div class="col-xs-4"><input type="text" name="transDate" class="form-control input-sm date-picker" value="${wlFlowImccNode.transDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
