			                            ...
			                            <div id="tab-1" class="tab-pane active">
			                                <div class="panel-body">
			                                    <div class="dataTables_wrapper form-inline">
													<form id="pageForm" action="${basePath}/sup/supcompany/order/listBgFlowExccOrder/${nodeType}/${flowId}/${isCompany}" class="form-horizontal formValidate" method="post">
														<div class="row">
								                            <div class="col-sm-12">
								                            ...
								                            <div class="col-sm-12 ssClass" >
								                             	...
								                             	<label class="tables_search_label">
								                                                                                                          服务商 ：<input type="text" class="input-sm form-control" name="searchName3" value="${searchBean.searchName3}">
								                                </label>
								                                </c:if>
																			...
																			<c:choose>
									                                         ...
									                                         <c:if test="${empty item[3]}">
																			   ...
																			   <c:if test="${not empty item[3]}">
																				...
																				<%-- <fmt:formatDate value="${item[3]}" pattern="yy/MM/dd HH:mm"/> --%>
																	       </td>
																			<td>
																			      <c:choose>
																				       ...
																				       <!-- 服务商  -->
																				        <c:choose>
																				               <c:when test="${item[8] eq '9'}">
																					                  ...
																					                  <a class="" target="iframe_PM" href="${basePath }/sup/order/ExportCustomsDeAgreementexcc/viewExportCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">

																						                   <span> 查看</span>
																					                  </a>
																				               </c:when>
																				              <c:when test="${item[8] eq '10'}">
																				                           <a class=""  onclick="openLayers('添加','${basePath }/sup/orderCccontroller/orderCc/${item[0]}/bgex',true)">
																							                  <span>维护进度</span>
																						                   </a> 
																						                    <a class="" target="iframe_PM" href="${basePath }/sup/order/ExportCustomsDeAgreementexcc/editExportCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                       <span>修改</span>
																					                        </a>
