	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/bgexcc/saveFlowExccNodeGreenLight" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-xs-2 control-label">放行时间</label>
	                            <div class="col-xs-4"><input type="text" name="releaseDate" class="form-control  date-picker" value="${flowExccNode.releaseDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
							...
							<div id="inGroup2">
							      <div class="form-group" >
			                          <label class="col-xs-2 control-label">操作一级部门</label>
									 <div class="col-xs-4">
									...
									<label class="col-xs-2 control-label">操作二级部门</label>
									<div class="col-xs-4">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-xs2 control-label" style="padding-left: 0px;">完成情况说明</label>
	                            <div class="col-xs-4"><input type="text" name="remarks" value="${flowExccNode.remarks}" class="form-control" minlength="1"></div>
	                        </div>
	                         <div class="form-group">
								<div class="form-group">
			                      	<label class="col-xs2 control-label">备注</label>
