                    ...
                    <div class="mo-main-wrap">
                        ...
                        <div class="mo-list-nav ui2-navigation ui2-navigation-wide">
                            <div class="ui2-navigation-content util-clearfix">
									 ...
									 <a class="ui2-navigation-item ui2-navigation-item-current" href="${basePath}/sup/supcompany/order/toFlowImccPage/${isCompany}" data-name="expressExportOrder"> 进口报关 </a> 
                            ...
                            <div class="ui2-tab ui2-tab-normal zh-cn" id="ordersTab">
                                <ul class="ui2-tab-nav">
                                     <c:if test="${isCompany eq '0' }">
                                        ...
                                        target="ImccOrder" href="${basePath}/sup/supcompany/order/listFlowImccOrder/0/${flowId}/${isCompany}">
                                            所有订单 <span class="number"></span>
                                    </a></li>
                                    <li><a
                                        target="ImccOrder" href="${basePath}/sup/supcompany/order/listFlowImccOrder/${handle}/${flowId}/${isCompany}">
                                            处理中<span class="number"></span>
                                    </a></li>
                                    <li><a
                                        target="ImccOrder" href="${basePath}/sup/supcompany/order/listFlowImccOrder/${complete}/${flowId}/${isCompany}">
                                            已完成<span class="number"></span>
                                    </a></li>
                                     <li><a
                                        target="ImccOrder" href="${basePath}/sup/supcompany/order/listFlowImccOrder/10/${flowId}/${isCompany}">
                                          已接收<span class="number"></span>
                                    </a></li>
                                    <li><a
                                        target="ImccOrder" href="${basePath}/sup/supcompany/order/listFlowImccOrder/11/${flowId}/${isCompany}">
                                          拒绝订单<span class="number"></span>
                                    </a></li>
                                    <li><a
                                        target="ImccOrder" href="${basePath}/sup/supcompany/order/listFlowImccOrder/14/${flowId}/${isCompany}">
                                   ...
                                   <c:if test="${isCompany eq '1' }">
                                    ...
                                    <li><a
                                        target="ImccOrder" href="${basePath}/sup/supcompany/order/listFlowImccOrder/${cansole}/${flowId}/${isCompany}">
                                            已取消 <span class="number"></span>
                                    </a></li>
                                    <li><a
                                        target="ImccOrder" href="${basePath}/sup/supcompany/order/listFlowImccOrder/${draft}/${flowId}/${isCompany}">
                                ...
                                -->
                                <iframe id="test" style="width: 100%;min-height: 660px;" name="ImccOrder" src="${basePath }/sup/supcompany/order/listFlowImccOrder/0/${flowId}/${isCompany}" frameborder="0" scrolling="no" border="0" framespacing="0"></iframe>
