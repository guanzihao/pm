	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/bgimcc/saveFlowImccNodeCheck" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-xs-2 control-label">查验时间</label>
	                            <div class="col-xs-4"><input type="text" name="inspectionDate" class="form-control  date-picker" value="${flowImccNode.inspectionDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
	                        ...
	                        <div class="form-group">
	                            <div class="col-xs-12 col-sm-offset-2" style="margin-left: 10px;">
