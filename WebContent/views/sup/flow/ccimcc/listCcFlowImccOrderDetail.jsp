			                            ...
			                            <div id="tab-1" class="tab-pane active">
			                                <div class="panel-body">
			                                    <div class="dataTables_wrapper form-inline">
													<form id="pageForm" action="${basePath }/sup/supcompany/order/showCcFlowImccOrderList/${nodeType}/${flowId}/${isCompany}" class="form-horizontal formValidate" method="post">
														<div class="row">
								                            <div class="col-sm-12">
																				       ...
																				       <!-- 服务商  -->
																				        <c:choose>
																				               <c:when test="${item[8] eq '9'}">
																					                  ...
																					                  <a class=""target="iframe_PM" href="${basePath }/sup/order/OrderFrom/viewCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                   <span> 查看</span>
																					                  </a>
																				               </c:when>
																				              <c:when test="${item[8] eq '10'}">
																				                           <a class=""  onclick="openLayers('添加','${basePath }/sup/orderCccontroller/orderCc/${item[0]}/ccim',true)">
																							                  <span>维护进度</span>
																						                   </a> 
																						                    <a class="" target="iframe_PM" href="${basePath }/sup/order/OrderFrom/editPurchaseOrderProduction/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                       <span>修改</span>
																					                        </a>
																						                    <a class=""target="iframe_PM" href="${basePath }/sup/order/OrderFrom/viewCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                        <span> 查看</span>
																				    ...
																				    <c:if test="${isCompany eq '1' }">
																				       ...
																				       <c:choose>
																		                 <c:when test="${item[8] eq '1'}">
																		                        <a class="" href="javascript:;" onclick="toolTableUpdate('${basePath }/sup/supcompany/order/tijiaoupdatestateorder','${item[0] }','提交')">
																						              <span>提交</span>
																					             </a>
																					             <a class=""target="iframe_PM" href="${basePath }/sup/order/OrderFrom/viewCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						              <span> 查看</span>
