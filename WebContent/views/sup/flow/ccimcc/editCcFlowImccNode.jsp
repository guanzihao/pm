	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/ccimcc/saveCcFlowImccNode" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-xs-2 control-label" style="padding-left: 0px;">接单登记时间</label>
	                            <div class="col-xs-4"><input type="text" name="orderReceivingDate" class="form-control input-sm date-picker" value="${ccFlowImccNode.orderReceivingDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
			                      	<label class="col-xs-2 control-label">备注</label>
									<div class="col-xs-10"><textarea name="remarks" class="form-control " rows="6">${ccFlowImccNode.remarks }</textarea></div>
								</div>
							</div>
	                        <div class="form-group">
