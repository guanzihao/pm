	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/ccimcc/saveCcFlowImccNodeVehicleArrives" method="post">
	                       ...
	                       <div class="form-group">
	                       		<label class="col-xs-2 control-label">入库地址</label>
	                            <div class="col-xs-4">
	                       ...
	                       <div class="form-group">
	                        	<label class="col-xs-2 control-label">实际入库时间</label>
	                            <div class="col-xs-4"><input type="text" name="actualStoringDate" class="form-control input-sm date-picker" value="${ccFlowImccNode.actualStoringDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
