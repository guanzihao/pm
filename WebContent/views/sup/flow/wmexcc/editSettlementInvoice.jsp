	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/wmexcc/saveSettlementInvoice" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label">结算单生效时间</label>
	                            <div class="col-sm-4"><input type="text" name="balanceDate" class="form-control input-sm date-picker" value="${wmFlowExccNode.balanceDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
