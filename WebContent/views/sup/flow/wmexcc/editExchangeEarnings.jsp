	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/wmexcc/saveExchangeEarnings" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label">收汇时间</label>
	                            <div class="col-sm-4"><input type="text" name="receiveDate" class="form-control input-sm date-picker" value="${wmFlowExccNode.receiveDate}" maxlength="200"></div>
	                        	<label class="col-sm-2 control-label">收汇金额</label>
	                            <div class="col-sm-4"><input type="text" name="recAmount" class="form-control" value="${wmFlowExccNode.recAmount}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label">外汇币种</label>
	                            <div class="col-sm-4"><input type="text" name="recCurrency" class="form-control" value="${wmFlowExccNode.recCurrency}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
