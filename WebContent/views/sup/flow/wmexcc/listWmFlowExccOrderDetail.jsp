			                            ...
			                            <div id="tab-1" class="tab-pane active">
			                                <div class="panel-body">
			                                    <div class="dataTables_wrapper form-inline">
													<form id="pageForm" action="${basePath }/sup/supcompany/order/showWmFlowExccOrder/${nodeType}/${flowId}/${isCompany}" class="form-horizontal formValidate" method="post">
														<div class="row">
								                            <div class="col-sm-12">
															...
															<table class="">
												                ...
												                <tbody>
												                	<c:forEach items="${pageBean.pageList }" var="item" varStatus="status">
																		...
																		<td>
																		          <c:choose>
															                             <c:when test="${item[16] eq '1'}">未提交</c:when>
															                             ...
															                             <c:when test="${item[16] eq '9'}">已提交</c:when>
																				       ...
																				       <!-- 服务商  -->
																				        <c:choose>
																				               <c:when test="${item[16] eq '9'}">
																					                  ...
																					                  <a class=""target="iframe_PM" href="${basePath }/sup/order/ex/viewCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                   <span> 查看</span>
																					                  </a>
																				               </c:when>
																				              <c:when test="${item[16] eq '10'}">
																				                           <a class=""  onclick="openLayer('添加','${basePath }/sup/orderCccontroller/orderCc/${item[0]}/wmex',true)">
																							                  <span>维护进度</span>
																						                   </a> 
																						                    <a class="" target="iframe_PM" href="${basePath }/sup/order/ex/editExportContract/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                       <span>修改</span>
																					                        </a>
																						                    <a class=""target="iframe_PM" href="${basePath }/sup/order/ex/viewCustomsDeAgreement/${item[0] }/${nodeType}/${flowId}/${isCompany}">
																						                        <span> 查看</span>
