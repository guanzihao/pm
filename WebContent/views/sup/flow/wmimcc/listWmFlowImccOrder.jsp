                    ...
                    <div class="mo-main-wrap">
                        ...
                        <div class="mo-list-nav ui2-navigation ui2-navigation-wide">
                            <div class="ui2-navigation-content util-clearfix">
	                                ...
	                                <a  class="ui2-navigation-item ui2-navigation-item-current" href="${basePath}/sup/supcompany/order/toWmFlowImccOrderPage/${isCompany}" data-name="zzzy"> 外贸进口 </a>
                            ...
                            <div class="ui2-tab ui2-tab-normal zh-cn" id="ordersTab">
                                <ul class="ui2-tab-nav">
                                     <c:if test="${isCompany eq '0' }">
                                        ...
                                        target="WmFlowImccOrder" href="${basePath}/sup/supcompany/order/listWmFlowImccOrder/0/${flowId}/${isCompany}">
                                            所有订单 <span class="number"></span>
                                    </a></li>
                                    <li><a
                                        target="WmFlowImccOrder" href="${basePath}/sup/supcompany/order/listWmFlowImccOrder/${handle}/${flowId}/${isCompany}">
                                            处理中<span class="number"></span>
                                    </a></li>
                                    <li><a
                                        target="WmFlowImccOrder" href="${basePath}/sup/supcompany/order/listWmFlowImccOrder/${complete}/${flowId}/${isCompany}">
                                            已完成<span class="number"></span>
                                    </a></li>
                                     <li><a
                                        target="WmFlowImccOrder" href="${basePath}/sup/supcompany/order/listWmFlowImccOrder/10/${flowId}/${isCompany}">
                                          已接收<span class="number"></span>
                                    </a></li>
                                    <li><a
                                        target="WmFlowImccOrder" href="${basePath}/sup/supcompany/order/listWmFlowImccOrder/11/${flowId}/${isCompany}">
                                          拒绝订单<span class="number"></span>
                                    </a></li>
                                    <li><a
                                        target="WmFlowImccOrder" href="${basePath}/sup/supcompany/order/listWmFlowImccOrder/14/${flowId}/${isCompany}">
                                   ...
                                   <c:if test="${isCompany eq '1' }">
                                    ...
                                    <li><a
                                        target="WmFlowImccOrder" href="${basePath}/sup/supcompany/order/listWmFlowImccOrder/${cansole}/${flowId}/${isCompany}">
                                            已取消 <span class="number"></span>
                                    </a></li>
                                    <li><a
                                        target="WmFlowImccOrder" href="${basePath}/sup/supcompany/order/listWmFlowImccOrder/${draft}/${flowId}/${isCompany}">
                                ...
                                -->
                                <iframe id="test" style="width: 100%;min-height: 660px;" name="WmFlowImccOrder" src="${basePath}/sup/supcompany/order/listWmFlowImccOrder/0/${flowId}/${isCompany}" frameborder="0" scrolling="no" border="0" framespacing="0"></iframe>
