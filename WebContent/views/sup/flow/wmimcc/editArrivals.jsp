	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/wmimcc/saveArrivals" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label">到货生效时间</label>
	                            <div class="col-sm-4"><input type="text" name="arrivalDate" class="form-control input-sm date-picker" value="${wmFlowImccNode.arrivalDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
