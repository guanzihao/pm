	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/wmimcc/savePayments" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label">实收时间</label>
	                            <div class="col-sm-4"><input type="text" name="payTime" class="form-control input-sm date-picker" value="${wmFlowImccNode.payTime}" maxlength="200"></div>
	                        	<label class="col-sm-2 control-label">付货款金额</label>
	                            <div class="col-sm-4"><input type="text" name="payAmount" class="form-control" value="${wmFlowImccNode.payAmount}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label">币种</label>
	                            <div class="col-sm-4"><input type="text" name="payCurrency" class="form-control" value="${wmFlowImccNode.payCurrency}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
