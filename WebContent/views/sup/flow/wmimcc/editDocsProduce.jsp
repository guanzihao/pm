	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/wmimcc/saveDocsProduce" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label">合同生效时间</label>
	                            <div class="col-sm-4"><input type="text" name="contractStartDate" class="form-control input-sm date-picker" value="${wmFlowImccNode.contractStartDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
