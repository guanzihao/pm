	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/flow/wlexcc/saveCustomsDeclaration" method="post">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-xs-4"><input type="text" name="releaseDate" class="form-control input-sm date-picker" value="${wlFlowExccNode.releaseDate}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
