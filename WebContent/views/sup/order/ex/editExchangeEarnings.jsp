	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form id="tijiao"  class="form-horizontal formValidate" action="${basePath }/sup/flow/wmexccs/saveExchangeEarnings" method="post">
	                        ...
	                        <div class="form-group">
	                         <div class="col-xs-2">
	                        	<label class=" control-label">收汇时间：</label>
	                        	</div>
	                            <div class="col-xs-4"><input type="text" name="receiveDate"id="receiveDate"  class="form-control input-sm date-picker" value="<fmt:formatDate value="${wmFlowExccNode.receiveDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        	 <div class="col-xs-2">
	                        	<label class="width control-label">收汇金额：</label>
	                        	</div>
	                            <div class="col-xs-4"><input type="text" name="recAmount" class="form-control" value="${wmFlowExccNode.recAmount}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
	                         <div class="col-xs-2">
	                        	<label class=" control-label">外汇币种：</label>
	                        	</div>
	                            <div class="col-xs-4"><input type="text" name="recCurrency" class="form-control" value="${wmFlowExccNode.recCurrency}" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
								<div class="col-xs-2">
...
<script type="text/javascript">
	...
	function tijiao(){
		...
		var releaseDate =duibi($("#receiveDate").val().split(" ")[0]);
		if(startDate<=endDate){
			if(releaseDate<=endDate){
				if(releaseDate>=startDate){
					...
					layer.alert("收汇时间不能小于开始时间");
				}
			}else{
				layer.alert("收汇时间不能大于结束时间");
			}
		}else{
