	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form id="tijiao" class="form-horizontal formValidate" action="${basePath }/sup/flow/wmexccs/saveTaxRefund" method="post">
	                        ...
	                        <div class="form-group">
	                         <div class="col-xs-2" style="padding-left: 0px;">
	                        	<label class=" control-label">退税申请单生效时间：</label>
	                        	</div>
	                            <div class="col-xs-4"><input type="text" name="refundTime"id="refundTime" class="form-control input-sm date-picker" value="<fmt:formatDate value="${wmFlowExccNode.refundTime}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
								 <div class="col-xs-2">
...
<script type="text/javascript">
	...
	function tijiao(){
		...
		var releaseDate =duibi($("#refundTime").val().split(" ")[0]);
		if(startDate<=endDate){
			if(releaseDate<=endDate){
				if(releaseDate>=startDate){
					...
					layer.alert("退税申请单生效时间不能小于开始时间");
				}
			}else{
				layer.alert("退税申请单生效时间不能大于结束时间");
			}
		}else{
