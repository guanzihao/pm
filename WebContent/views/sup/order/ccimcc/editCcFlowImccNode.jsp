	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form id="tijiao" class="form-horizontal formValidate" action="${basePath }/sup/flow/ccimccs/saveCcFlowImccNode" method="post">
	                        ...
	                        <div class="form-group">
	                        	 <div class="col-xs-2">
	                        	<label class=" control-label">接单登记时间：</label>
	                        	</div>
	                            <div class="col-xs-4"><input type="text" name="orderReceivingDate"id="orderReceivingDate" class="form-control input-sm date-picker" value="<fmt:formatDate value="${ccFlowImccNode.orderReceivingDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
								 <div class="col-xs-2">
	...
	if(startDate<=endDate){
		if(releaseDate<=endDate){
			if(releaseDate>=startDate){
				...
				layer.alert("接单登记时间不能小于开始时间");
			}
		}else{
			layer.alert("接单登记时间不能大于结束时间");
		}
	}else{
