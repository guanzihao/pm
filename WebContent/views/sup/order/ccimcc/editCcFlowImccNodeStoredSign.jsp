	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form id="tijiao" class="form-horizontal formValidate" action="${basePath }/sup/flow/ccimccs/saveCcFlowImccNodeStoredSign" method="post">
	                        ...
	                        <div class="form-group">
	                         ...
	                         <div class="form-group">
	                          <div class="col-xs-2">
	                        	<label class=" control-label">入库完成时间：</label>
	                        	</div>
	                            <div class="col-xs-4"><input type="text" name="storedFinishDate"id="storedFinishDate" class="form-control input-sm date-picker" value="<fmt:formatDate value="${ccFlowImccNode.storedFinishDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
								<div class="col-xs-2">
...
function tijiao(){
	...
	var releaseDate =duibi($("#storedFinishDate").val().split(" ")[0]);
	if(startDate<=endDate){
		if(releaseDate<=endDate){
			if(releaseDate>=startDate){
				...
				layer.alert("入库完成时间不能小于开始时间");
			}
		}else{
			layer.alert("入库完成时间不能大于结束时间");
		}
	}else{
