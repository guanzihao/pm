...
<meta charset="UTF-8">
								...
								<div class="mo-process mo-order-process">
									<ul class="mo-process-10 util-clearfix">
										...
										<li
											...
											<span class="label">车辆到达</span>
										</li>
	
										<li
											class="mo-process-item mo-process-done-item " style="width:33%;">
	
											<span class="label" >入库签收</span>
										</li>
									</ul>
								</div>
							</div>
				...
				<div class="ui2-tab-body ui2-tab-content">
					...
					<div id="myTabContent" class="tab-content" style="border: 1px solid #dedede; border-top: 0px;padding: 5px;">
						<div id="weituohan" class="tab-pane fade"> 
								...
								<div style="text-align:center;width:30%;border:1px solid black;border-left:0px;margin-left:299px;margin-top:-22px;">仓储进口</div>
										...
										<c:forEach items="${pageBean.pageList}" var="item">
														...
														<div style="width:50%;float:left;"
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-68">
																<label class="ui-form-label" data-label="预计出货日期">
																	<i class="ui-form-required"></i>采购单编号 :<span class="J-display">${item[5]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" >
																	<i class="ui-form-required"></i> 买方:<span>${item[6]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="HS编码">
																	<i class="ui-form-required"></i> 买方地址 :<span>${item[7]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="重量">
																	<i class="ui-form-required"></i> 发布日期 :<span><fmt:formatDate value="${item[8]}" pattern="yyyy-MM-dd"/></span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="包装情况">
																	<i class="ui-form-required"></i> 委托方:<span>${item[9]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-76" style="display: block;">
																<label class="ui-form-label" data-label="包装情况">
																	<i class="ui-form-required"></i> 项目 :<span>${item[10]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="合同号">
																	<i class="ui-form-required"></i> 买方联系电话:<span>${item[11]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="许可文件号">
																	<i class="ui-form-required"></i> 买方传真:<span>${item[12]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="货物总价">
																	<i class="ui-form-required"></i>供应商 :<span>${item[13]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="进出口日期">
																	<i class="ui-form-required"></i>供应商编号 :<span>${item[14]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="提单号">
																	<i class="ui-form-required"></i>联系人 :<span>${item[15]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="贸易方式">
																	<i class="ui-form-required"></i> 联系人地址 :<span class="J-display">${item[16]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="货源地">
																	<i class="ui-form-required"></i> 联系人电话 :<span class="J-display">${item[17]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="其他要求">
																	联系人传真: <span class="J-display">${item[18]}</span></label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="被委托方">
																	合同期限 : <span class="J-display">${item[19]} </span></label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="报关单编码">
																	交货时间:<span class="J-display"><fmt:formatDate value="${item[20]}" pattern="yyyy-MM-dd"/> </span> </label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	交付说明:<span class="J-display">${item[21]}</span> </label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	交付条款:<span class="J-display">${item[22]}</span> </label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	国际贸易条件:<span class="J-display">${item[23]}</span> </label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	包装: <span class="J-display">${item[24]}</span></label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	保险:<span class="J-display">${item[25]}</span> </label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	币种:<span class="J-display">${item[26]}</span> </label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	工装费用:<span class="J-display">${item[27]}</span> </label>
									...
									<c:forEach items="${imContractDetail}" var="item">
										<div class="edit-block J-content " style="width:1255px;margin-left:35px;" >
											...
											<div style="width:50%;float:left;"
												...
												data-widget-cid="widget-86" style="display: block;">
												<label class="ui-form-label" >
													价格有效期:<span class="J-display">${item[1]}</span> </label>
											...
											<div style="width:50%;float:left;"
												...
												data-widget-cid="widget-86" style="display: block;">
												<label class="ui-form-label" >
													型号:<span class="J-display">${item[2]}</span> </label>
											...
											<div style="width:50%;float:left;"
												...
												data-widget-cid="widget-86" style="display: block;">
												<label class="ui-form-label" >
													单价: <span class="J-display">${item[3]}</span></label>
											...
											<div style="width:50%;float:left;"
												...
												data-widget-cid="widget-86" style="display: block;">
												<label class="ui-form-label" >
													数量:<span class="J-display">${item[4]}</span> </label>
											</div>
											</div>
										</c:forEach>
								</div>
						...
						<div id="danjuxiangqing" class="tab-pane fade">
						     ...
						     <div class="col-sm-12 tables_search_label">
										<a class="" href="javascript:;" onclick="ajaxTable('${basePath }/sup/order/OrderFrom/saveFlow/${order_code.id}/D8994C5C-533C-42E2-9BFD-46E5639844D2',  'removeToolTableTr', '添加单据信息')">
											<span>添加仓储进库单据</span>
										</a>
									</div>
					                <div class="ibox-content" style="height: 100%;">
										<form id="pageForm1" action="${basePath }" method="post">
											<div class="col-sm-3">
												<c:import url="/views/sup/order/bgimcc/bgFlowImccOrderTree.jsp">
				                        ...
				                        <div class="col-sm-9">
				                       		 <iframe id="deptUserList" src="${basePath}/sup/Ccimcc/listCcimcc/${order_code.id}"  frameborder="1" width="100%" style="min-height: 580px;"></iframe>
				                        </div>
									</div>
							</div>
						</div>
										...
										<c:forEach items="${pageBean.pageList}" var="item">
														...
														<div style="margin-top:4px;"
															...
															<div style="margin-top:4px;"
																...
																data-widget-cid="widget-68">
																<label class="ui-form-label" data-label="预计出货日期">
																	<i class="ui-form-required"></i>采购单编号 :
																</label>
															...
															<div style="margin-top:4px;"
																...
																data-widget-cid="widget-75">
																<label class="ui-form-label" data-label="重量">
																	<i class="ui-form-required"></i> 发布日期 :
																</label>
															...
															<div style="margin-top:4px;"
																...
																data-widget-cid="widget-79">
																<label class="ui-form-label" data-label="货物总价">
																	<i class="ui-form-required"></i>供应商 :
																</label>
															...
															<div style="margin-top:4px;"
																...
																data-widget-cid="widget-80">
																<label class="ui-form-label" data-label="进出口日期">
																	<i class="ui-form-required"></i>供应商编号 :
																</label>
																<div class="ui-form-control">
																	<div class="contact-preview">
																		<span>${item[14]}</span>
															...
															<div style="margin-top:4px;"
																...
																data-widget-cid="widget-81">
																<label class="ui-form-label" data-label="提单号">
																	<i class="ui-form-required"></i>联系人 :
																</label>
															...
															<div style="margin-top:4px;"
																...
																data-widget-cid="widget-82" style="display: block;">
																<label class="ui-form-label" data-label="贸易方式">
																	<i class="ui-form-required"></i> 联系人地址 :
																</label>
															...
															<div style="margin-top:4px;"
																...
																data-widget-cid="widget-83" style="display: block;">
																<label class="ui-form-label" data-label="货源地">
																	<i class="ui-form-required"></i> 联系人电话 :
																</label>
															...
															<div style="margin-top:4px;"
																...
																<div class="ui-form-control">
																	<span class="J-display"><fmt:formatDate value="${item[20]}" pattern="yyyy-MM-dd"/> </span>
																</div>
															</div>
							...
							<article class="step  node-accordion ui-view-mode" id="step03" data-widget-cid="widget-67" style="display: block;">
									<div class="payee-container  view-mode wl2-3">
										<h2 class="step-header">
											...
											<div class="step-content " >
											<c:forEach items="${pageBean.pageList}" var="item">
												 <pm:execute id="importContract" bean="supOrderFromBusinImpl" method="infos">
														<pm:execute-param type="java.lang.String" value="${item[0]}" />
												</pm:execute>
												<pm:fileList metaObject="${importContract}" delete="false" metaColums="columsCcIc" />
					                            </c:forEach>
											</div>
									</div>
							</article>
					...
					<c:if test="${usertype =='sup'}">
						<c:if test="${order_code.orderState =='9'}">
							<a class="btn btn-white btn-sm myBtn" href="${basePath }/sup/supcompany/order/supupdateorderoks/${order_code.id}/${nodeType}/${flowId}/${isCompany}/ccim">
								<span> 接收</span>
							</a>
							<a class="btn btn-white btn-sm myBtn" href="${basePath }/sup/supcompany/order/supupdateorders/${order_code.id}/${nodeType}/${flowId}/${isCompany}/ccim">
								<span> 拒绝</span>
							</a>
						</c:if>
					</c:if>
	...
	var jiedian2=$("#jiedian2").val();
  	...
  	if(jiedian1=='1'){
  		...
  		$("#jiedians1").addClass("mo-process-item last mo-process-current-item ");
  	}
  	if(jiedian3=='1'){
