	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form  id="tijiao"  class="form-horizontal formValidate" action="${basePath }/sup/flow/bgimccs/saveFlowImccNodeGreenLight" method="post">
	                        ...
	                        <div class="form-group">
	                        <div class="col-xs-2">
	                        	<label class=" control-label">放行时间：</label>
	                        	</div>
	                            <div class="col-xs-4"><input type="text" name="releaseDate" id="releaseDate" class="form-control  date-picker" value="<fmt:formatDate value="${flowImccNode.releaseDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        </div>
	                        <!-- <div class="form-group"> -->
	                        <%-- <div class="col-xs-2">
    		...
    		if(startDate<=endDate){
    			if(releaseDate<=endDate){
    				if(releaseDate>=startDate){
    					...
    					layer.alert("放行时间不能小于开始时间");
    				}
    			}else{
    				layer.alert("放行时间不能大于或等于结束时间");
    			}
    		}else{
