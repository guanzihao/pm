	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form id="tijiao" class="form-horizontal formValidate" action="${basePath }/sup/flow/bgimccs/saveFlowImccNode" method="post">
	                        ...
	                        <div class="col-xs-2">
	                            ...
	                            <div class="col-xs-4"><input type="text" name="bussinessDate"id="bussinessDate"  class="form-control  date-picker" value="<fmt:formatDate value="${flowImccNode.bussinessDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        </div>
	                      <%--   <div class="form-group">
	                        		<div class="col-xs-2">
