	...
	<div class="wrapper wrapper-content animated fadeIn">
		<div class="row">
	    	<div class="col-sm-12 tables_search_label" style="margin-left:20px;margin-top:10px;">
	    		<a class="btn btn-success" href="${basePath }/sup/flow/bgimccs/listBgFlowImccOrderReceiving/${billId}/0">
					<span>接单</span>
				</a>
				<pm:authCom authCode="info_listAllComLoginLog">
		        	<a class="btn btn-success" href="${basePath }/sup/flow/bgimccs/listBgFlowImccCheck/${billId}/0">
						<span>查验</span>
					</a>
				</pm:authCom>
				...
				<a class="btn btn-success" style="margin-left:600px;" href="${basePath }/sup/orderCccontroller/orderCc/${orderid.orderFrom.id}/bgim">
					<span>返回</span>
				</a>
	        </div>
	    </div>
	            ...
	            <div class="ibox float-e-margins">
	                <div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<form id="pageForm" action="${basePath }/sup/flow/bgimccs/listBgFlowImccGreenLight/${billId}/0" class="form-horizontal formValidate" method="post">
								<div class="row">
									<div class="col-sm-12 tables_search_label">
										<pm:authCom authCode="organize_editInterface">
											<a class="btn btn-white btn-sm" href="javascript:;" onclick="openLayerSize('添加','${basePath }/sup/flow/bgimccs/editFlowImccNodeGreenLight/0/${billId }',true,'90%','90%')">
												<span><i class=""></i> 添加</span>
											</a>
										</pm:authCom>
										<pm:authCom authCode="organize_removeInterface">
											<a class="btn btn-white btn-sm" href="javascript:;" onclick="toolTable('${basePath }/sup/flow/bgimccs/removeFlowImccNode', 'ids', 'removeToolTableTr', '删除')">
									...
									<table class="table table-striped table-bordered table-hover dataTable">
										<thead>
											<tr>
												...
												<th class="sorting<c:if test="${searchBean.searchOrderName eq 'a.releaseDate'}">${searchBean.searchOrderType ? '_desc' : '_asc'}</c:if>" onclick="goSubmitSort('a.releaseDate', ${!searchBean.searchOrderType})">放行时间</th>
											</tr>
										</thead>
										<tbody>
												...
												<tr id="toolTr_${item[0] }">
													...
													<td>
														<pm:authCom authCode="role_editOrgRole">
															<a class="btn btn-white btn-xs" href="javascript:;" onclick="openLayerSize('修改','${basePath }/sup/flow/bgimccs/editFlowImccNodeGreenLight/${item[0] }/${billId }', true,'90%','90%')">
																<span>修改</span>
															</a>
														</pm:authCom>
														<pm:authCom authCode="organize_listLoginLog">
															<a class="btn btn-xs btn-white" href="javascript:;" onclick="openLayer('查看详情','${basePath }/sup/flow/bgimccs/viewFlowImccNodeGreenLight/${item[0]}/${billId }',false)">
																<span>  查看详情</span>
															</a>
														</pm:authCom>
													</td>
													...
													<td>
														<pm:execute id="bgFlowExccBusin" bean="bgFlowImccBusinImpl" method="getFlowImccNode">
															<pm:execute-param type="java.lang.String" value="${item[0]}" />
														</pm:execute>
														<pm:fileList metaObject="${bgFlowExccBusin}" delete="false" metaColums="colums" />
													</td>
