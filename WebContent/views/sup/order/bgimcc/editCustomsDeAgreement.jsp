	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/order/CustomsDeAgreementimcc/saveCustomsDeAgreement" method="post">
	                        ...
	                        <div class="col-xs-2">
	                            ...
	                            <div class="col-xs-4"><input type="text" name="deliveryNumber" class="form-control" required="" value="" maxlength="15" ></div>
	                        </div>
	                        ...
	                        <div class="form-group">
	                        	<div class="col-xs-2">
	                        	<label class="col-xs-2 control-label">报关收费</label>
	                        	</div>
