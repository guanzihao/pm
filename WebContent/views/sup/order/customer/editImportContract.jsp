...
<script type="text/javascript">
	...
	function addTr2(tab, row) {
		var trHtml = '<tr align="center">'
				...
				+ '<td><input  type="hidden" name="ids" value="1"><input  type="hidden"  name="commodityId" value="1123123" id="commodityNameId_'+num+'"><input  required=""  id="commodityName_'
				+ num
				+ '" class="form-control input" type="text"  name="commodityName" onclick="wmlllOnclick(\'_'
				+ num
				+ '\',\'gys\')" readonly="readonly"/></td>'
				+ '<td><input type="text"  id="models_'+num+'" name="models"       class="form-control input" readonly="readonly">'
				+ '<td><input type="text" id="quantity_'
				+ num
				+ '" name="quantity'
				+ num
				+ '"  class="form-control input quantity"  required=""  number="true"   onkeyup="quantityKeyup(\''
				+ num
				+ '\')" onblur="quantityKeyup(\''
				+ num
				+ '\')" ></td>'
	...
	function initRow() {
		...
		for (var i = 0; i < datas.length; i++) {
			...
			var trHtml = '<tr align="center">'
					...
					+ '" value="'
					+ data.quantity
					+ '" class="form-control input quantity"   number="true"   onkeyup="quantityKeyup(\''
					+ num+ '\')" onblur="quantityKeyup(\''
					+ num+ '\')" ></td>'
...
<body>
	<div id="boxWmIc" class="container wmIc">
		<div class="row">
			...
			<div id="main" class="col-xs-12">
				<form class="form-horizontal formValidate wmForm"
					action="${basePath }/sup/order/ic/saveObject/${nodeType}/${flowId}/${isCompany}"
					method="post">
					<input type="hidden" name="id" value="${importContract.id }">
					<input type="hidden" id="isDelegationId" name="isDelegation" value="${importContract.isDelegation }">
					...
					<input type="hidden" name="taskId" value="${importContract.taskId }"> 
						<input type="hidden" id="typeId" value="${flowId }"> 
						<span id="wmDetailId" style="display: none;">${imContractDetails }</span> 
						...
						<article class="step col-xs-12 wm1-1">
							<h2 class="step_header">
								<img src="${basePath }/resource/images/icon_c1.png"
									class="step_icon wm1-2" alt="" /> 外贸进口
							</h2>
							...
							<div class="ibox-content wm1-3">
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" value="${importContract.consignor }" required="" name="consignor" class="form-control" >
									</div>
									<c:if test="${importContract.isDelegation eq '0' }">
										<label class="col-sm-2 wm control-label">合同号码<font></font></label>
										<div class="col-sm-3 wm">
											<input type="text" value="${importContract.contractNo }"
												name="contractNo" class="form-control" >
										</div>
									</c:if>
								</div>
								<c:if test="${importContract.isDelegation eq '0' }">
									<div class="form-group wm">
										<label class="col-sm-2 control-label">合同日期<font></font></label>
										<div class="col-sm-3">
											<input type="text" name="contractDate"
												value="<fmt:formatDate value="${importContract.contractDate }" pattern="yyyy-MM-dd"/>"
												class="form-control date-picker" dateISO="true" >
										</div>
										<label class="col-sm-2 control-label">买方<font></font></label>
										<div class="col-sm-3">
											<input type="text" value="${importContract.buyers }"
												name="buyers" class="form-control" >
										</div>
									</div>
									<div class="form-group wm">
										<label class="col-sm-2 control-label">买方地址<font></font></label>
										<div class="col-sm-3">
											<input type="text" value="${importContract.bAddress }"
												name="bAddress" class="form-control" >
										</div>
										<label class="col-sm-2 control-label">买方传真<font></font></label>
										<div class="col-sm-3">
											<input type="text" value="${importContract.bFax }" name="bFax"
												class="form-control" >
										</div>
									</div>
									<div class="form-group wm">
										...
										<div class="col-sm-3">
											<input type="text" value="${importContract.bTelphone }"
												name="bTelphone" class="form-control" >
										</div>
										<pm:execute id="supCompanyInfo" bean="companyInfoBusinImpl"
											method="getSupCompanyInfo">
											<pm:execute-param type="java.lang.String"
												value="${importContract.sellers }" />
										</pm:execute>
										<label class="col-sm-2 control-label">卖方<font></font></label>
										<div class="col-sm-3">
											<input type="text" value="${importContract.sellers }"
												name="sellers" class="form-control sellersName" >
										</div>
									</div>
									<div class="form-group wm">
										<label class="col-sm-2 control-label">卖方地址<font></font></label>
										<div class="col-sm-3">
											<input type="text" value="${importContract.sAddress }"
												name="sAddress" class="form-control sAddress" >
										</div>
										<label class="col-sm-2 control-label">卖方传真<font></font></label>
										<div class="col-sm-3">
											<input type="text" value="${importContract.sFax }" name="sFax"
												class="form-control sFax" >
										</div>
									</div>
									<div class="form-group wm">
										<label class="col-sm-2 control-label">卖方联系方式<font></font></label>
										<div class="col-sm-3">
											<input type="text" value="${importContract.sTelphone }"
												name="sTelphone" class="form-control sTelphone" >
										</div>
									</div>
								</c:if>
								<div class="col-xs-12">
									<button type="button"
										class="ui_form_button ui_form_right wm1-4">下一步</button>
								</div>
							</div>

						</article>
					<c:if test="${importContract.isDelegation eq '0' }">
						<article class="row step col-xs-12 wm2-1 wm">
							<h2 class="step_header">
								<img src="${basePath }/resource/images/icon_f2.png"
									class="step_icon wm2-2" alt="" /> 产品及开票人信息
							</h2>
							...
							<div class="step_content col-xs-11 col-xs-offset-1 wm2-3" style="display: none;">
								<div class="row">
									<div class="col-sm-12 tables_search_label">
										<a class="btn btn-white btn-sm" href="javascript:;"
											onclick="addTr2('tab', -1)"> <span><i
												class="fa fa-plus"></i> 添加一行</span>
										</a> <a class="btn btn-white btn-sm" href="javascript:;"
											onclick="delTr2()"> <span><i class="fa fa-plus"></i>
												删除行</span>
										</a>
									</div>
								</div>
								...
								<div class="col-xs-12">
									<button type="button"
										class="ui_form_button ui_form_right wm2-4">下一步</button>
								</div>
						...
						<article class="step col-xs-12 wm3-1 wm">
							<h2 class="step_header">
								<img src="${basePath }/resource/images/icon_f3.png"
									class="step_icon wm3-2" alt="" /> 运输及付款信息
							</h2>
							...
							<div class="ibox-content wm3-3" style="display: none;">
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" value="${importContract.manufactory }"  required="" name="manufactory" class="form-control" >
									</div>
									<label class="col-sm-2 control-label">币制<font>*</font></label>
									<div class="col-sm-3">
										<input type="text" value="${importContract.inspection }" required=""
											name="inspection" class="form-control" >
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">付款条件<font></font></label>
									<div class="col-sm-3">
										<input type="text" value="${importContract.termPayment }"
											name="termPayment" class="form-control" >
									</div>
									<label class="col-sm-2 control-label">仲裁条款<font></font></label>
									<div class="col-sm-3">
										<input type="text" value="${importContract.arbitration }"
											name="arbitration" class="form-control" >
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">装运时间<font></font></label>
									<div class="col-sm-3">
										<input type="text" name="shipmentTime"
											value="<fmt:formatDate value="${importContract.shipmentTime }" pattern="yyyy-MM-dd"/>"
											class="form-control date-picker" dateISO="true" >
									</div>
									<label class="col-sm-2 control-label">交货时间<font></font></label>
									<div class="col-sm-3">
										<input type="text" value="<fmt:formatDate value="${importContract.deliveryTime }" pattern="yyyy-MM-dd"/>"
											name="deliveryTime" class="form-control date-picker"
											 dateISO="true">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" value="${importContract.portShipment }"
											name="portShipment" class="form-control" >
									</div>
									<label class="col-sm-2 control-label">目的口岸<font></font></label>
									<div class="col-sm-3">
										<input type="text" value="${importContract.portDestination }"
											name="portDestination" class="form-control" >
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-2 control-label">包装<font></font></label>
									<div class="col-sm-3">
										<input type="text" value="${importContract.packing }"
											name="packing" class="form-control" >
									</div>
									<label class="col-sm-2 control-label">保险<font></font></label>
									<div class="col-sm-3">
										<input type="text" value="${importContract.insurance }"
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" value="${importContract.others }"  required="" name="others" class="form-control" >
									</div>
								</div>
								<div class="col-xs-12">
									<button type="button"
										class="ui_form_button ui_form_right wm3-4">下一步</button>
								</div>
							</div>
						</article>
					</c:if>
									...
									<c:choose>
										<c:when test="${supCompanyInFo eq '1' }">
											<div class="form-group">
					                           ...
					                           <div class="col-sm-3"><input type="text" required="" id="startDateWmIcId" name="startDate"  value="<fmt:formatDate value="${importContract.startDate }" pattern="yyyy-MM-dd"/>" class="form-control " readonly="readonly" dateISO="true"   ></div>
					                        	<label class="col-sm-2 control-label">结束时间<font>*</font></label>
					                            <div class="col-sm-3"><input id="endDateWmIcId" required="" type="text" value="<fmt:formatDate value="${importContract.endDate }" pattern="yyyy-MM-dd"/>" name="endDate" class="form-control "  readonly="readonly"   dateISO="true" ></div>
				                        	</div>
				                        	<div class="form-group">
					                      		<label class="col-sm-2 control-label">内容详情<font></font></label>
												<div class="col-sm-8"><textarea name="explain" id="explainWmIcId" class="form-control " readonly="readonly" rows="6" >${importContract.explain }</textarea></div>
											</div>
										</c:when>
										<c:otherwise>
											<div class="form-group">
					                        	<label class="col-sm-2 control-label">开始时间<font>*</font></label>
					                           <div class="col-sm-3"><input type="text" required="" id="startDateWmIcId" name="startDate"  value="<fmt:formatDate value="${importContract.startDate }" pattern="yyyy-MM-dd"/>" class="form-control date-picker" dateISO="true"   ></div>
					                        	<label class="col-sm-2 control-label">结束时间<font>*</font></label>
					                            <div class="col-sm-3"><input id="endDateWmIcId" required="" type="text" value="<fmt:formatDate value="${importContract.endDate }" pattern="yyyy-MM-dd"/>" name="endDate" class="form-control date-picker"     dateISO="true" ></div>
				                        	</div>
				                        	<div class="form-group">
					                      		<label class="col-sm-2 control-label">内容详情<font></font></label>
												<div class="col-sm-8"><textarea name="explain" id="explainWmIcId" class="form-control " rows="6" >${importContract.explain }</textarea></div>
											</div>
										</c:otherwise>
									</c:choose>
									<div class="col-xs-12">
						...
						<article class="step col-xs-12 wm5-1 ">
							<h2 class="step_header">
								<img src="${basePath }/resource/images/icon_f5.png"
									class="step_icon wm5-2" alt="" /> 附件上传
							</h2>
							<div class="step_content col-xs-11 col-xs-offset-1 wm5-3" style="display: none;">

								<div class="form-group">
									<div class="col-sm-10">
										<pm:fileList metaObject="${importContract }" delete="true"
											name="fileArray" metaColums="columsWmIc" />
...
<script type="text/javascript">
	...
	var hhhhh = "";
	function wmlllOnclick(id, flag) {
		var taskTypeId = $("#typeId").val();
		var url = '';
		if (flag == 'gys') {
			hhhhh = id;
			url = '${basePath }/sup/task/listProduct/' + taskTypeId
					+ "/updatewmIc";
		} else {
			url = '${basePath }/sup/task/listCompanyInfo/' + taskTypeId
					+ "/editWmIc";
		}
		//iframe层-父子操作
		layer.open({
	...
	function returnValueSpUpdateWmIc(selectValues) {
	...
	function returnValueWmIc(selectValues) {
		if (selectValues != '' || selectValues.length > 0) {
			var strId = selectValues[0];
