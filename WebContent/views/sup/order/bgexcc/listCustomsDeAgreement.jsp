					...
					<div id="myTabContent" class="tab-content" style="border: 1px solid #dedede; border-top: 0px;padding: 5px;">
						...
						<div id="danjuxiangqing" class="tab-pane fade">
								...
								<div class="col-sm-12 tables_search_label">
										<a class="" href="javascript:;" onclick="ajaxTable('${basePath }/sup/order/OrderFrom/saveFlow/${order_code.id}/AA6F9D76-D751-4EBC-BA6A-2E4872FCA36C',  'removeToolTableTr', '添加单据信息')">
											<span>添加出口报关单据</span>
										</a>
									</div>
									<form id="pageForm1" action="${basePath }" method="post">
										<div class="col-sm-3">
											<c:import url="/views/sup/order/bgexcc/bgFlowExccOrderTree.jsp">
			                        ...
			                        <div class="col-sm-9" >
			                       		 <iframe id="deptUserList" src="${basePath}/sup/Bgexcc/listBgExcc/${order_code.id}" runat="server"   width="100%" height="500px;" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes" ></iframe>
			                        </div>
							</div>
						 </div>
