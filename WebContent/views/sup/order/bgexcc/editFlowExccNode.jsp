				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form id="tijiao" class="form-horizontal formValidate"
							action="${basePath }/sup/flow/bgexccs/saveFlowExccNode"
							method="post">
							...
							<div class="col-xs-2">
								...
								<div class="col-xs-4">
									<input type="text" name="startDate" id="startDate"
										...
										value="<fmt:formatDate value="${flowExccNode.startDate}" pattern="yyyy-MM-dd"/>" maxlength="200">
								</div>
								<div class="col-xs-2">
								...
								<div class="col-xs-4">
									<input type="text" name="endDate" id="endDate"
										class="form-control date-picker"
										value="<fmt:formatDate value="${flowExccNode.endDate}" pattern="yyyy-MM-dd"/>" maxlength="50">
								</div>
							</div>
							<div class="form-group">
							<div class="col-xs-2">
								...
								<div class="col-xs-4">
									<input type="text" name="bussinessDate" id="bussinessDate"
										class="form-control  date-picker"
										value="<fmt:formatDate value="${flowExccNode.bussinessDate}" pattern="yyyy-MM-dd"/>" maxlength="200">
								</div>
							</div>
							<%-- <div class="form-group">
								<div class="col-xs-2" >
							...
							<div id="outGroup">
								<div class="form-group">
									...
									<div class="col-xs-4">
										<input
											type="text" name="opeComp" class="form-control"
											value="${flowExccNode.opeComp}" required="" minlength="1"/>
									</div>
								</div>
							</div>
							<div id="inGroup">
									...
									<div class="col-xs-4" >
										<select class="selectpicker" name="firstDept">
											<c:forEach items="${supplierList}" var="item"
												varStatus="status">
												<c:choose>
													<c:when test="${item.comCode eq flowExccNode.firstDept}">
														<option value="${item.id}" selected="selected">${item.comName}</option>
													</c:when>
													<c:otherwise>
														<option value="${item.comCode}">${item.comName}</option>
													</c:otherwise>
												</c:choose>
											</c:forEach>
										</select>
							...
							<div class="col-xs-2">
								...
								<div class="col-xs-4" >
									<pm:fileList metaObject="${flowExccNode }" delete="true"
										name="flowImccNodeFiles" metaColums="colums" />
							...
							<div class="col-xs-2">
								...
								<div class="col-xs-4" >
									<input type="text" name="remarks"
										value="${flowExccNode.remarks}" class="form-control"
										minlength="1">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-xs-2">
									...
									<div class="col-xs-9" style="padding-left: 15px;">
										<textarea name="note" class="form-control " rows="6">${flowExccNode.note }</textarea>
									</div>
								</div>
							</div>
...
<script type="text/javascript">
	...
	function tijiao() {
		...
		var releaseDate = duibi($("#bussinessDate").val().split(" ")[0]);
