	...
	<div class="wrapper wrapper-content animated fadeIn">
		<div class="row">
	    	<div class="col-sm-12 tables_search_label" style="margin-left:20px;margin-top:10px;">
				<a class="btn btn-success" href="${basePath }/sup/flow/wltransports/listWlFlowTransportOrderReceiving/${billId}/0">
					<span>接单</span>
				</a>
	        	<a class="btn btn-info" href="javascript:;">
					<span>运输</span>
				</a>
				<a class="btn btn-success" href="${basePath }/sup/flow/wltransports/listWlFlowTransportArrivalReceipt/${billId}/0">
					<span>到货签收</span>
				</a>
				<a class="btn btn-success" style="margin-left:600px;" href="${basePath }/sup/orderCccontroller/orderCc/${orderid.orderFromId}/wltrop">
					<span>返回</span>
				</a>
	        </div>
	    </div>
	            ...
	            <div class="ibox float-e-margins">
	                <div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<form id="pageForm" action="${basePath }/sup/flow/wltransports/listWlFlowTransporting/${billId}/0" class="form-horizontal formValidate" method="post">
		                        <div class="row">
									<div class="col-sm-12 tables_search_label">
										<pm:authCom authCode="organize_editInterface">
											<a class="btn btn-white btn-sm" href="javascript:;" onclick="openLayerSize('添加','${basePath }/sup/flow/wltransports/editWlFlowTransportNodeTransporting/0/${billId }',true,'90%','90%')">
												<span> 添加</span>
											</a>
										</pm:authCom>
										<pm:authCom authCode="organize_removeInterface">
											<a class="btn btn-white btn-sm" href="javascript:;" onclick="toolTable('${basePath }/sup/flow/wltransports/removeWlFlowTransportNode', 'ids', 'removeToolTableTr', '删除')">
												<span> 删除</span>
											</a>
										</pm:authCom>
									</div>
									...
									<table class="table table-striped table-bordered table-hover dataTable">
										<thead>
											<tr>
												...
												<th class="sorting<c:if test="${searchBean.searchOrderName eq 'a.origin'}">${searchBean.searchOrderType ? '_desc' : '_asc'}</c:if>" onclick="goSubmitSort('a.origin', ${!searchBean.searchOrderType})">起运地</th>
												<th class="sorting<c:if test="${searchBean.searchOrderName eq 'a.destination'}">${searchBean.searchOrderType ? '_desc' : '_asc'}</c:if>" onclick="goSubmitSort('a.destination', ${!searchBean.searchOrderType})">目的地</th>
											</tr>
										</thead>
										<tbody>
												...
												<tr id="toolTr_${item[0] }">
													...
													<td>
														<pm:authCom authCode="role_editOrgRole">
															<a class="btn btn-white btn-xs" href="javascript:;" onclick="openLayerSize('修改','${basePath }/sup/flow/wltransports/editWlFlowTransportNodeTransporting/${item[0] }/${billId }', true,'90%','90%')">
																<span> 修改</span>
															</a>
														</pm:authCom>
														<pm:authCom authCode="organize_listLoginLog">
															<a class="btn btn-xs btn-white" href="javascript:;" onclick="openLayer('查看详情','${basePath }/sup/flow/wltransports/viewWlFlowTransportNodeTransporting/${item[0]}/${billId }',false)">
																<span> 查看详情</span>
															</a>
														</pm:authCom>
													</td>
													...
													<td>
														<pm:execute id="wlFlowTransportNode" bean="wlFlowTransportBusinImpl" method="getWlFlowTransportNode">
