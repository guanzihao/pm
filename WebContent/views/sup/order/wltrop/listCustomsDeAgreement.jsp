								...
								<div class="mo-process mo-order-process">
									<ul class="mo-process-10 util-clearfix">
										...
										<li
											...
											<span class="label">运输</span>
										</li>
										
										<li
											class="mo-process-item mo-process-done-item  " style="width:33%">
	
											<span class="label">到货签收</span>
										</li>
				...
				<div class="ui2-tab-body ui2-tab-content">
					...
					<div id="myTabContent" class="tab-content" style="border: 1px solid #dedede; border-top: 0px;padding: 5px;">
						<div id="weituohan" class="tab-pane fade"> 
								...
								<div style="text-align:center;width:30%;border:1px solid black;border-left:0px;margin-left:299px;margin-top:-22px;">物流运输</div>
														...
														<div style="width:50%;float:left;"
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="HS编码">
																	<i class="ui-form-required"></i> 起运地 :<span>${item[7]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="包装情况">
																	<i class="ui-form-required"></i>  目的地 :<span>${item[9]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	签名盖章:<span class="J-display">${item[32]}</span> </label>
						...
						<div id="danjuxiangqing" class="tab-pane fade">
						     ...
						     <div class="col-sm-12 tables_search_label">
										<a class="" href="javascript:;" onclick="ajaxTable('${basePath }/sup/order/OrderFrom/saveFlow/${order_code.id}/CF734401-5F26-4A3B-82B3-1B7A6DAFE35D',  'removeToolTableTr', '添加单据信息')">
											<span>添加物流运输单据</span>
										</a>
									</div>
		                <div class="ibox-content" style="height: 100%;">
							<form id="pageForm1" action="${basePath }" method="post">
								<div class="col-sm-2">
									<c:import url="/views/sup/order/wltrop/WlTransportOrderTree.jsp">
	                        ...
	                        <div class="col-sm-10">
	                       		 <iframe id="deptUserList" src="${basePath }/sup/Wltransport/listWltransport/${order_code.id}" frameborder="1" width="100%" ></iframe>
	                        </div>
						</div>
					</div>
						</div>
										...
										<c:forEach items="${pageBean.pageList}" var="item">
														<div class="edit-block J-content " >
															...
															<div style="margin-top:4px;"
																...
																data-widget-cid="widget-74">
																<label class="ui-form-label" data-label="HS编码">
																	<i class="ui-form-required"></i> 起运地 :
																</label>
															...
															<div style="margin-top:4px;"
																...
																data-widget-cid="widget-76" style="display: block;">
																<label class="ui-form-label" data-label="包装情况">
																	<i class="ui-form-required"></i> 目的地 :
																</label>
							...
							<article class="step  node-accordion ui-view-mode" id="step03" data-widget-cid="widget-67" style="display: block;">
									<div class="payee-container  view-mode wl2-3">
										<h2 class="step-header">
											...
											<div class="title">物流运输信息附件</div>
										</h2>
											<div class="step-content " >
											<c:forEach items="${pageBean.pageList}" var="item">
												 <pm:execute id="importContract" bean="tropShippingExCommissionBusinImpl" method="getShippingExCommission">
														<pm:execute-param type="java.lang.String" value="${item[0]}" />
												</pm:execute>
												
												<pm:fileList metaObject="${importContract}" delete="false" metaColums="columsWlTrop" />
					...
					<c:if test="${usertype =='sup'}">
						<c:if test="${order_code.orderState =='9'}">
							<a class="btn btn-white btn-sm myBtn"  href="${basePath }/sup/supcompany/order/supupdateorderoks/${order_code.id}/${nodeType}/${flowId}/${isCompany}/wltrop">
								<span> 接收</span>
							</a>
							<a class="btn btn-white btn-sm myBtn" href="${basePath }/sup/supcompany/order/supupdateorders/${order_code.id}/${nodeType}/${flowId}/${isCompany}/wltrop">
								<span> 拒绝</span>
							</a>
						</c:if>
					</c:if>
