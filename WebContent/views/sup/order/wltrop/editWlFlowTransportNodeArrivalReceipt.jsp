	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form id="tijiao" class="form-horizontal formValidate" action="${basePath }/sup/flow/wltransports/saveWlFlowTransportNodeArrivalReceipt" method="post">
...
<label class=" control-label">结束时间：</label>
	                        ...
	                        <div class="col-xs-2">
	                            ...
	                            <div class="col-xs-4"><input type="text" name="transDate" id="transDate" class="form-control input-sm date-picker" value="<fmt:formatDate value="${wlFlowTransportNode.transDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
								<div class="col-xs-2">
...
function tijiao(){
	...
	var releaseDate =duibi($("#transDate").val().split(" ")[0]);
	if(startDate<=endDate){
		if(releaseDate<=endDate){
			if(releaseDate>=startDate){
				...
				layer.alert("签收时间不能小于开始时间");
			}
		}else{
			layer.alert("签收时间不能大于结束时间");
		}
	}else{
