	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form id="tijiao" class="form-horizontal formValidate" action="${basePath }/sup/flow/wlimccs/saveDeliverGoods" method="post">
	                        ...
	                        <div class="col-xs-2">
	                            ...
	                            <div class="col-xs-4"><input type="text" name="vehicleDate" id="vehicleDate" class="form-control input-sm date-picker" value="<fmt:formatDate value="${wlFlowImccNode.vehicleDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                            <div class="col-xs-2" style="padding-left: 0px;">
	                            <label class=" control-label">运输完成时间：</label>
	                            </div>
	                            <div class="col-xs-4"><input type="text" name="transDate" class="form-control input-sm date-picker" value="<fmt:formatDate value="${wlFlowImccNode.transDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
								<div class="col-xs-2">
