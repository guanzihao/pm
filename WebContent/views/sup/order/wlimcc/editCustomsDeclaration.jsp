	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form id="tijiao" class="form-horizontal formValidate" action="${basePath }/sup/flow/wlimccs/saveCustomsDeclaration" method="post">
	                        ...
	                        <div class="col-xs-2" style="padding-left: 0px;">
	                            ...
	                            <div class="col-xs-4"><input type="text" name="releaseDate" id="releaseDate" class="form-control input-sm date-picker" value="<fmt:formatDate value="${wlFlowImccNode.releaseDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
								 <div class="col-xs-2">
