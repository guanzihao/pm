	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form id="tijiao" class="form-horizontal formValidate" action="${basePath }/sup/flow/wlimccs/saveExchangeOrder" method="post">
	                        ...
	                        <div class="form-group">
	                        	...
	                        	<label class=" control-label">实际到港时间：</label>
	                        	</div>
	                            <div class="col-xs-4"><input type="text" name="arrivalDate" id="arrivalDate"  class="form-control input-sm date-picker" value="<fmt:formatDate value="${wlFlowImccNode.arrivalDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                            <div class="col-xs-2">
	                            <label class=" control-label">换单时间：</label>
	                            </div>
	                            <div class="col-xs-4"><input type="text" name="switchBillDate" class="form-control input-sm date-picker" value="<fmt:formatDate value="${wlFlowImccNode.switchBillDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
								<div class="col-xs-2">
	...
	if(startDate<=endDate){
		if(releaseDate<=endDate){
			if(releaseDate>=startDate){
				...
				layer.alert("实际到港时间不能小于开始时间");
			}
		}else{
			layer.alert("实际到港时间不能大于结束时间");
		}
	}else{
