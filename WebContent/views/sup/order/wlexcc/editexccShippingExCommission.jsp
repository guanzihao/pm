	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/wuliuexcc/saveShippingExCommission" method="post">
	                        ...
	                        <div class="col-xs-2">
	                            ...
	                            <div class="col-xs-4"><input type="text" name=specialNotes class="form-control" required="" value="${companyInfo.comLink }" maxlength="200"></div>
