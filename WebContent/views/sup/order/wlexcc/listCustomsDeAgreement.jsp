									...
									<div class="mo-process mo-order-process">
										<ul class="mo-process-10 util-clearfix">
										 ...
										 "   style="width:20%;">
											...
											<div class="mo-process-mark">
												<i id="jiedians1" class="ui2-icon ui2-icon-dot is_no" style="padding-left:40%"></i>
											</div>
										...
										<li class="mo-process-item last mo-process-done-item 
										 "  style="width:20%;">
											...
											<div class="mo-process-mark">
												<i id="jiedians5" class="ui2-icon ui2-icon-dot is_no" style="padding-right:50%"></i>
											</div>
											<div class="mo-process-content" style="">
												<div class="" data-desc="" style="text-align:center">
													<a href="#">
				...
				<div class="ui2-tab-body ui2-tab-content">
					...
					<div id="myTabContent" class="tab-content" style="border: 1px solid #dedede; border-top: 0px;padding: 5px;">
						<div id="weituohan" class="tab-pane fade"> 
								...
								<div style="text-align:center;width:30%;border:1px solid black;border-left:0px;margin-left:299px;margin-top:-22px;">物流出口</div>
								...
								<div style="margin-top:20px;">
										<c:forEach items="${pageBean.pageList}" var="item">
														...
														<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-68">
																<label class="ui-form-label" data-label="预计出货日期">
																	<i class="ui-form-required"></i>备注内容:<span class="J-display">${item[37]}</span>
																</label>
														...
														<div style="width:50%;float:left;"
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	托运联系人: <span class="J-display">${item[25]}</span></label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	电话:<span class="J-display">${item[26]}</span> </label>
															...
															<div style="width:50%;float:left;"
																...
																data-widget-cid="widget-86" style="display: block;">
																<label class="ui-form-label" >
																	传真: <span class="J-display">${item[27]}</span></label>
						...
						<div id="danjuxiangqing" class="tab-pane fade">
						       ...
						       <div class="col-sm-12 tables_search_label">
										<a class="" href="javascript:;" onclick="ajaxTable('${basePath }/sup/order/OrderFrom/saveFlow/${order_code.id}/0320ACB2-6E61-4E14-BE1A-DB8F116F9DFE',  'removeToolTableTr', '添加单据信息')">
											<span>添加出口物流单据</span>
										</a>
									</div>
		                <div class="ibox-content" style="height: 100%;">
							<form id="pageForm1" action="${basePath }" method="post">
								<div class="col-sm-3">
									<c:import url="/views/sup/order/wlexcc/WlExccOrderTree.jsp">
	                        ...
	                        <div class="col-sm-9">
	                       		 <iframe id="deptUserList" src="${basePath}/sup/Wlexcc/listWlexcc/${order_code.id}" frameborder="1" width="100%" style="min-height: 580px;"></iframe>
	                        </div>
						</div>
					</div>
						</div>
							...
							<article class="step  node-accordion ui-view-mode" id="step03" data-widget-cid="widget-67" style="display: block;">
									<div class="payee-container  view-mode wl2-3">
										<h2 class="step-header">
											...
											<div class="title">物流出口信息附件</div>
										</h2>
											<div class="step-content " >
											<c:forEach items="${pageBean.pageList}" var="item">
												<pm:execute id="importContract" bean="exportShippingExCommissionBusinImpl" method="getShippingExCommission">
														<pm:execute-param type="java.lang.String" value="${item[0]}" />
												</pm:execute>
												<pm:fileList metaObject="${importContract}" delete="false" metaColums="columsWlEc" />
					...
					<c:if test="${usertype =='sup'}">
						<c:if test="${order_code.orderState =='9'}">
							<a class="btn btn-white btn-sm myBtn" href="${basePath }/sup/supcompany/order/supupdateorderoks/${order_code.id}/${nodeType}/${flowId}/${isCompany}/wlex">
								<span> 接收</span>
							</a>
							<a class="btn btn-white btn-sm myBtn" href="${basePath }/sup/supcompany/order/supupdateorders/${order_code.id}/${nodeType}/${flowId}/${isCompany}/wlex">
								<span> 拒绝</span>
							</a>
						</c:if>
					</c:if>
