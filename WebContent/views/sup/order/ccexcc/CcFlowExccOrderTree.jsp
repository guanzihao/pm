...
$(function () {
	...
	$('#jstree_<%=name %>').on("changed.jstree", function (e, data) {
		...
		$("#deptUserList").attr("src","${basePath }/sup/order/ExportOrderFrom/listCcFlowExccOrderDesc/"+data.selected+"/"+data.node.original.hierarchy+"/"+data.node.original.taskTypeId);
	});
});
