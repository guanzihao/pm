					...
					<div id="myTabContent" class="tab-content" style="border: 1px solid #dedede; border-top: 0px;padding: 5px;">
						...
						<div id="danjuxiangqing" class="tab-pane fade">
						       ...
						       <div class="col-sm-12 tables_search_label">
										<a class="" href="javascript:;" onclick="ajaxTable('${basePath }/sup/order/OrderFrom/saveFlow/${order_code.id}/D33A899D-C46B-438A-90BC-C2F395E8AFCE',  'removeToolTableTr', '添加单据信息')">
											<span>添加仓储出库单据</span>
										</a>
									</div>
		                <div class="ibox-content" style="height: 100%;">
							<form id="pageForm1" action="${basePath }" method="post">
								<div class="col-sm-3">
									<c:import url="/views/sup/order/ccexcc/CcFlowExccOrderTree.jsp">
	                        ...
	                        <div class="col-sm-9">
	                       		 <iframe id="deptUserList" src="${basePath}/sup/Ccexcc/listCcexcc/${order_code.id}" frameborder="1" width="100%" style="min-height: 580px;"></iframe>
	                        </div>
						</div>
					</div>
						 </div>
