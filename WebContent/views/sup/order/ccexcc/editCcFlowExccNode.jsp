	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form id="tijiao" class="form-horizontal formValidate" action="${basePath }/sup/flow/ccexccs/saveCcFlowExccNode" method="post">
	                        ...
	                        <div class="col-xs-2">
	                            ...
	                            <div class="col-xs-4"><input type="text" name="orderReceivingDate"id="orderReceivingDate" class="form-control input-sm date-picker" value="<fmt:formatDate value="${ccFlowExccNode.orderReceivingDate}" pattern="yyyy-MM-dd"/>" maxlength="200"></div>
	                        </div>
	                        <div class="form-group">
								<div class="form-group">
								<div class="col-xs-2">
									...
									<div class="col-xs-4"><textarea name="remarks" class="form-control " rows="6">${ccFlowExccNode.remarks }</textarea></div>
								</div>
							</div>
	                        <div class="form-group">
	                        <div class="col-xs-2">
...
function tijiao(){
	...
	var releaseDate =duibi($("#orderReceivingDate").val().split(" ")[0]);
