...
<meta charset="UTF-8">
							...
							<div class="mo-f-inner-l mo-list-item-order util-clearfix">
								<div class="mo-process mo-order-process">
									<ul class="mo-process-10 util-clearfix">
										<li class="mo-process-item first mo-process-done-item " style="width:14%">
	
											<span class="label" >单证制作</span>
										</li>
	
										<li
											class="mo-process-item mo-process-done-item  "  style="width:14%">
										...
										<li
											...
											<span class="label" >收货款</span>
										</li>
										<li class="mo-process-item first mo-process-done-item "  style="width:14%">
	
											<span class="label" >付货款</span>
										</li>
	
										<li
											class="mo-process-item mo-process-done-item  " style="width:14%">
	
											<span class="label">进口到货</span>
										</li>
	
										<li
											class="mo-process-item mo-process-done-item " style="width:14%">
	
											<span class="label" >进口清关</span>
										</li>
										
										<li
											class="mo-process-item mo-process-done-item " style="width:14%">
	
											<span class="label" >业务结算</span>
										</li>
									</ul>
								</div>
							</div>
									...
									<div class="mo-process mo-order-process">
										...
										<li class="mo-process-item  mo-process-done-item 
										 "  style="width:14%">
											...
											<div class="mo-process-mark">
												<i id="jiedians6"  class="ui2-icon ui2-icon-dot is_no"></i>
											</div>
											<div class="mo-process-content" style="">
												<div class="" data-desc="" style="text-align:center">
													<a href="#">
										 ...
										 "   style="width:14%">
											...
											<div class="mo-process-mark">
												<i id="jiedians7" class="ui2-icon ui2-icon-dot is_no" style="padding-right:62%"></i>
											</div>
											<div class="mo-process-content" style="">
												<div class="" data-desc="" style="text-align:center">
													<a href="#">
													<input type="text" style="display:none;" ID="jiedian7" value="${order_code.node7State}"/>
													<c:choose>
														<c:when test="${order_code.node7State eq '１'}"><span class="label label-warning">已完成</span></c:when>
														<c:when test="${order_code.node7State eq '０'}"><span class="label label-warning">进行中</span></c:when>
														<c:when test="${order_code.node7State eq '3'}"><span class="label label-warning">未完成</span></c:when>
													</c:choose>
													</a>
												</div>
												<div class="mo-process-detail">
				...
				<div class="ui2-tab-body ui2-tab-content">
					...
					<div id="myTabContent" class="tab-content" style="border: 1px solid #dedede; border-top: 0px;padding: 5px;">
						<div id="weituohan" class="tab-pane fade"> 
								...
								<div style="text-align:center;width:30%;border:1px solid black;border-left:0px;margin-left:299px;margin-top:-22px;">外贸进口</div>
								...
								<div style="margin-top:20px;">
										...
										<c:forEach items="${pageBean.pageList}" var="item">
														...
														<div class="edit-block J-content " >
															<div  class="ui-form-item  node-entity entity-name-expect-declaration-date entity-type-calendar ui-view-mode"
																...
																<label class="ui-form-label" data-label="预计出货日期">
																	<i class="ui-form-required"></i>期望开始时间 :<span class="J-display"><fmt:formatDate value="${item[27]}" pattern="yyyy-MM-dd"/> </span>
																</label>
															...
															<div  class="ui-form-item  node-entity entity-name-expect-declaration-date entity-type-calendar ui-view-mode"
																data-widget-cid="widget-68" style="width:50%;float:left;">
																<label class="ui-form-label" data-label="预计出货日期">
																	<i class="ui-form-required"></i>期望完成时间:<span class="J-display"><fmt:formatDate value="${item[28]}" pattern="yyyy-MM-dd"/></span>
																</label>
														...
														<div  class="ui-form-item  node-entity entity-name-expect-declaration-date entity-type-calendar ui-view-mode"
																data-widget-cid="widget-68" style="width:50%;float:left;">
																<label class="ui-form-label" data-label="预计出货日期">
																	<i class="ui-form-required"></i>备注说明:<span class="J-display">${item[29]}</span>
																</label>
															...
															<div  class="ui-form-item  node-entity entity-name-expect-declaration-date entity-type-calendar ui-view-mode"
																data-widget-cid="widget-68" style="width:50%;float:left;">
																<label class="ui-form-label" data-label="预计出货日期">
																	<i class="ui-form-required"></i>委托方:<span class="J-display">${item[30]}</span>
																</label>
															...
															<div style="width:50%;float:left;"
																...
																<label class="ui-form-label" data-label="贸易方式">
																	<i class="ui-form-required"></i> 装运时间 :<span class="J-display"><fmt:formatDate value="${item[15]}" pattern="yyyy-MM-dd"/> </span>
																</label>
								...
								<div style="float:right;">
									<c:forEach items="${pageBean.pageList}" var="item">
										确认时间：<fmt:formatDate value="${item[30]}" pattern="yyyy-MM-dd"/>
									</c:forEach>
								</div>
						</div>
						<div id="danjuxiangqing" class="tab-pane fade">
							<div class="row">
									<div class="col-sm-12 tables_search_label">
										<a class="" href="javascript:;" onclick="ajaxTable('${basePath }/sup/order/OrderFrom/saveFlow/${order_code.id}/8EF423F7-8AF0-43F2-B03E-2F6E42276FE5',  'removeToolTableTr', '添加单据信息')">
											<span>添加外贸进口单据</span>
										</a>
									</div>
				                ...
				                <div class="ibox-content" style="height: 100%;">
									<form id="pageForm1" action="${basePath }" method="post">
										<div class="col-sm-3">
											<c:import url="/views/sup/order/ic/WmImccOrderTree.jsp">
			                        ...
			                        <div class="col-sm-9">
			                       		 <iframe id="deptUserList" src="${basePath}/sup/Wmimcc/listWmimcc/${order_code.id}"  frameborder="1" width="100%" style="min-height: 580px;"></iframe>
			                        </div>
								</div>
							</div>
						 </div>
							...
							<article class="step  node-accordion ui-view-mode" id="step03" data-widget-cid="widget-67" style="display: block;">
									<div class="payee-container  view-mode wl2-3">
										<h2 class="step-header">
											...
											<div class="title">外贸进口信息附件</div>
										</h2>
											<div class="step-content " >
											<c:forEach items="${pageBean.pageList}" var="item">
												<pm:execute id="importContract" bean="importContractBusinImpl" method="getImportContract">
														<pm:execute-param type="java.lang.String" value="${item[0]}" />
												</pm:execute>
												<pm:fileList metaObject="${importContract}" delete="false" metaColums="columsWmIc" />
				                            </c:forEach>
											</div>
									</div>
							</article>
					...
					<c:if test="${usertype =='sup'}">
						<c:if test="${order_code.orderState =='9'}">
							<a class="btn btn-white btn-sm myBtn" href="${basePath }/sup/supcompany/order/supupdateorderoks/${order_code.id}/${nodeType}/${flowId}/${isCompany}/wmim">
								<span> 接收</span>
							</a>
							<a class="btn btn-white btn-sm myBtn" href="${basePath }/sup/supcompany/order/supupdateorders/${order_code.id}/${nodeType}/${flowId}/${isCompany}/wmim">
								<span> 拒绝</span>
							</a>
						</c:if>
					</c:if>
	...
	var jiedian2=$("#jiedian2").val();
  	...
  	if(jiedian7=='1'){
  		$("#jiedians7").removeClass();
  		$("#jiedians7").addClass("ui2-icon ui2-icon-dot is_ok");
  	}
