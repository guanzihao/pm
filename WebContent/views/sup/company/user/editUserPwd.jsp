	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/company/user/saveUserPwd" method="post">
	                        <input type="hidden" name="token" value="${token}">
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label">原密码<font>*</font></label>
	                            <div class="col-sm-10"><input type="password" name="userPwd" class="form-control" required="" minlength="6" maxlength="50" remote="${basePath}/sup/company/user/ajaxCheckUserNewPwd"></div>
	                        </div>
