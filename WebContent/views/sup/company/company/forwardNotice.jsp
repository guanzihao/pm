	            ...
	            <div class="ibox float-e-margins">
	                <div class="ibox-title">
	                    ...
	                    <div class="ibox-tools">
		                     <a class="btn btn-xs btn-white" href="${basePath }/sup/company/notice/notice/listNotice">
		                          返回列表
		                     </a>
						</div>
	                </div>
	                <div class="ibox-content">
	                    <form id="noticeForm" class="form-horizontal formValidate" action="${basePath }/sup/company/notice/notice/saveNotice" method="post">
