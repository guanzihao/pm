	            ...
	            <div class="ibox">
	                ...
	                <div class="ibox-content">
						<div class="dataTables_wrapper form-inline">
							<form id="pageForm" class="form-horizontal formValidate" action="${basePath }/sup/consignationQuote/listSupplierConsignationQuote/2"  method="post">
								<div class="row">
		                            <div class="col-sm-12">
		                        ...
		                        <div class="row">
									<div class="col-sm-12 tables_search_label">
										...
										<pm:authCom authCode="role_removeOrgRole">
									...
									<table class="table table-striped table-bordered table-hover dataTable">
										<thead>
											<tr>
												...
												<th class="sorting<c:if test="${searchBean.searchOrderName eq 'a.originPlace'}">${searchBean.searchOrderType ? '_desc' : '_asc'}</c:if>" onclick="goSubmitSort('a.originPlace', ${!searchBean.searchOrderType})">起始地点</th>
												<th class="sorting<c:if test="${searchBean.searchOrderName eq 'a.purposePlace'}">${searchBean.searchOrderType ? '_desc' : '_asc'}</c:if>" onclick="goSubmitSort('a.purposePlace', ${!searchBean.searchOrderType})">目的地点</th>
												<th class="sorting<c:if test="${searchBean.searchOrderName eq 'a.tonnage'}">${searchBean.searchOrderType ? '_desc' : '_asc'}</c:if>" onclick="goSubmitSort('a.tonnage', ${!searchBean.searchOrderType})">吨位</th>
