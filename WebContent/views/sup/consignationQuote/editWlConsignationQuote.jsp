	                    ...
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/consignationQuote/saveSupplierConsignationQuote" method="post">
	                      <input type="hidden" name="type" value="${type}">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-4"><input type="text" name="originPlace" class="form-control" required="" value="${consignationQuote.originPlace }" ></div>
	                            <label class="col-sm-2 control-label"><i class="ired">*</i>目的地点</label>
	                            <div class="col-sm-4"><input type="text" name="purposePlace" class="form-control" required="" value="${consignationQuote.purposePlace }" ></div>
	                        </div>
	                        <div class="form-group">
	                            <label class="col-sm-2 control-label"><i class="ired">*</i>吨位</label>
	                            <div class="col-sm-4"><input type="text" name="tonnage" class="form-control" number="true" required="" value="${consignationQuote.tonnage }" ></div>
