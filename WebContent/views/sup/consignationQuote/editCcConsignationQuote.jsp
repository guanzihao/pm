	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/sup/consignationQuote/saveSupplierConsignationQuote" method="post">
	                        ...
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label"><i class="ired">*</i>仓储地点</label>
	                            <div class="col-sm-10"><input type="text" name="site" class="form-control" required="" value="${consignationQuote.site }" ></div>
	                        </div>
	                        <div class="form-group">
	                        	<label class="col-sm-2 control-label"><i class="ired">*</i>报价类型</label>
	                            <div class="col-sm-4">
	                            ...
	                            <div class="col-sm-4"><input type="text" name="price" class="form-control" required="" number="true" value="${consignationQuote.price }"></div>
	                        </div>
	                        <div class="form-group">
