		            ...
		            <div class="ibox-content">
						<div class="row">
							...
							<div class="col-sm-6">
								<dl class="dl-horizontal">
									<dt>吨位</dt>
									<dd>${consignationQuote.tonnage }吨</dd>
								</dl>
							</div>
							<div class="col-sm-6">
								<dl class="dl-horizontal">
							...
							<div class="col-sm-6">
								<dl class="dl-horizontal">
									<dt>状态</dt>
									<dd>
										<c:if test="${consignationQuote.checkState eq '0'}"><span class="label label-warning">未审核</span></c:if>
										<c:if test="${consignationQuote.checkState eq '1'}"><span class="label label-danger">已审核</span></c:if>
										<c:if test="${consignationQuote.checkState eq '-1'}"><span class=" label label-danger"> 未提交</span></c:if>
									</dd>
								</dl>
							</div>
						</div>
