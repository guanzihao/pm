...
<head>
	...
	<body>
		...
		<form  class="formValidate_2" role="form" action="${basePath }/common/userlogin/userLogin" method="post">
			<div class=bannerzc_kf >
				<div class="banner_k" style="height: 404px;">
				  ...
				  <input type="hidden" name="flowType" value="${flowType}"/>
					<div style="" class="bk_log">
						<div style="" class="log_txt">客服登录</div>
						...
						<div class="inp_c" >
							...
							<input type="text" name="loginName" id="loginName" value="" placeholder="请输入邮箱"/>
						</div>
						...
						<div >
							...
							<input type="text" name="kaptchaId"  id="kaptchaId" value=""placeholder="请输入验证码"  class="inp_d"  style="float:left;" />
							<img id="usercodeImg_gys" onclick="updatekaptcha('usercodeImg_gys')" width="40%" height="38" style="float:left;">
						</div>
						<div style="color:red;float:left;margin-right:115px;" >${cwxx }</div>
						<div id="info"></div>
