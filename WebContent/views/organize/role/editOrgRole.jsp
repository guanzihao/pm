	        ...
	        <div class="col-lg-12">
	            <div class="ibox float-e-margins">
	                ...
	                <div class="ibox-content">
	                    <form class="form-horizontal formValidate" action="${basePath }/organize/role/saveOrgRole" method="post">
	                        ...
	                        <div class="form-group">
	                            ...
	                            <div class="col-sm-10"><input type="text" name="roleCode" class="form-control" value="${orgRole.roleCode }" required="" minlength="1" maxlength="50" remote="${basePath}/organize/role/ajaxCheckOrgRole?roleId=${orgRole.id}"></div>
	                        </div>
